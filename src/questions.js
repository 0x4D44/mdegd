...
export const questions = [
  ...
  { id: 652, category: "canada-airports", question: "Why do Canadian airport codes almost all start with 'Y'?", year: null,
    eric: { options: ["'Y' = 'Yes, this weather station has an airport' — prepended to old 2-letter station codes", "Y stands for 'Yukon' — the first Canadian airports were in the Yukon", "It's from the French 'aéroport' — the Y represents the French pronunciation", "Canada chose Y because the US had already used most other letters"], correct: 0, explanation: "In the 1930s, Canadian weather stations had 2-letter identifiers. When IATA standardised 3-letter codes, Canada prepended 'Y' to stations that had airports ('Yes, there's an airport here'). Stations without airports got other prefixes like 'W'. That's why nearly every Canadian airport starts with Y." },
    ruth: { options: ["Y means 'Yes, there's an airport here'!", "Y means 'Yes, there's an airport here'!", "Very Canadian — polite and practical", "Eric didn't know this (now he does)"], correct: 0, explanation: "Y = Yes! 'Yes, this weather station has an airport.' The most Canadian reason possible for an airport code system." } },
  { id: 653, category: "canada-airports", question: "YYZ is Toronto Pearson. Why the double Y?", year: null,
    eric: { options: ["The old 2-letter station code was already YZ — adding the Y prefix created YYZ", "YZ was taken by another country, so they doubled the Y", "The second Y honours the city of York (Toronto's old name)", "It's a transcription error that was never corrected"], correct: 0, explanation: "Toronto's original 2-letter weather station code was YZ. When the Y prefix was added for 'Yes, airport,' it became Y-YZ = YYZ. The same thing happened to Calgary (YC → YYC), Victoria (YJ → YYJ), and St. John's (YT → YYT). Any station whose 2-letter code already started with Y gets a double-Y." },
    ruth: { options: ["The old code already started with Y!", "The old code already started with Y!", "Y + YZ = YYZ", "Eric can explain this at parties"], correct: 0, explanation: "The original 2-letter code was YZ. Add the Y prefix and you get YYZ. Same reason YYC, YYJ, and YYT have double Ys." } },
  { id: 654, category: "canada-airports", question: "Rush's instrumental 'YYZ' opens with a rhythm that encodes what in Morse code?", year: 1981,
    eric: { options: ["The letters Y-Y-Z (-.-- -.-- --..)", "The letters R-U-S-H", "The word 'Toronto' in abbreviated Morse", "SOS repeated three times"], correct: 0, explanation: "The opening rhythm is the Morse code for Y-Y-Z: dash-dot-dash-dash, dash-dot-dash-dash, dash-dash-dot-dot. From the album Moving Pictures (released 12 February 1981). Nominated for a Grammy for Best Rock Instrumental Performance at the 1982 ceremony — lost to The Police's 'Behind My Camel.'" },
    ruth: { options: ["Y-Y-Z in Morse code!", "Y-Y-Z in Morse code!", "Dash-dot-dash-dash, dash-dot-dash-dash, dash-dash-dot-dot", "Eric can tap it out (can he?)"], correct: 0, explanation: "Morse code for YYZ! Rush encoded Toronto's airport code into the opening rhythm. Lost the Grammy to The Police." } },
  { id: 655, category: "canada-airports", question: "What is the IATA code for Ottawa, and why does it sound painful?", year: null,
    eric: { options: ["YOW — from the old station code OW (OttaWa). Sounds like 'Ow!'", "YOT — from OTtawa", "YAW — from ottAWa", "YOA — from OttAwA"], correct: 0, explanation: "YOW — Y + OW, where OW derived from OttaWa. It does indeed sound like someone stubbing their toe. Other entertaining derivations: YUL (Montreal, from the old code UL), YEG (Edmonton), YWG (Winnipeg), YHZ (Halifax)." },
    ruth: { options: ["YOW! Sounds like it hurts!", "YOW! Sounds like it hurts!", "OW from OttaWa", "Eric says YOW when he stubs his toe"], correct: 0, explanation: "YOW! The most painful-sounding airport code in the world. From OttaWa." } },
  { id: 656, category: "canada-airports", question: "YYY is a real Canadian airport code. Where is it?", year: null,
    eric: { options: ["Mont-Joli, Quebec — the only triple-Y airport in the world", "Yellowknife, NWT", "Yarmouth, Nova Scotia", "Yorkton, Saskatchewan"], correct: 0, explanation: "Mont-Joli, Quebec — YYY. The only triple-Y airport code in the world. The original 2-letter station code was YY, so adding the Y prefix produced Y-YY = YYY. A beautiful piece of Canadian aviation trivia." },
    ruth: { options: ["Mont-Joli, Quebec! Triple Y!", "Mont-Joli, Quebec! Triple Y!", "YYY — the only one in the world", "Eric wants to fly there just to say he's been to YYY"], correct: 0, explanation: "Mont-Joli! The only airport in the world with three Ys. A collector's item for aviation nerds." } },
  { id: 657, category: "canada-airports", question: "Alert Airport (YLT) in Nunavut holds what world record?", year: null,
    eric: { options: ["The most northerly airport in the world — 82.5°N, just 508 miles from the North Pole", "The coldest airport in the world", "The smallest international airport", "The highest altitude airport in Canada"], correct: 0, explanation: "The most northerly airport in the world at 82.52°N — only 508 miles (817 km) from the North Pole. Alert is a Canadian Forces station and weather observatory. Population: about 62 (all military/research). It's closer to Moscow than to Ottawa." },
    ruth: { options: ["Most northerly airport in the world!", "Most northerly airport in the world!", "508 miles from the North Pole", "Eric has NOT been there (too cold)"], correct: 0, explanation: "The most northerly airport on Earth! 508 miles from the North Pole. Closer to Moscow than to Ottawa." } },
  { id: 658, category: "canada-airports", question: "Whitehorse Airport (YXY) is named after Erik Nielsen. What was his famous brother's career?", year: null,
    eric: { options: ["Actor — Leslie Nielsen (Airplane!, The Naked Gun)", "Musician — Harry Nilsson", "Astronaut — first Canadian in space", "Prime Minister of Denmark"], correct: 0, explanation: "Leslie Nielsen! Star of Airplane! (1980) and The Naked Gun series. His brother Erik Nielsen was Deputy Prime Minister of Canada (1984-1986) and MP for Yukon. The airport was renamed Erik Nielsen Whitehorse International Airport in 2008. Surely you can't be serious. I am serious — and don't call me Shirley." },
    ruth: { options: ["Leslie Nielsen! From Airplane!", "Leslie Nielsen! From Airplane!", "'Don't call me Shirley'", "Eric loves that film (doesn't everyone?)"], correct: 0, explanation: "Leslie Nielsen! The Naked Gun star's brother was Deputy PM of Canada. Don't call me Shirley." } },
  { id: 659, category: "canada-airports", question: "YFB is the code for Iqaluit, Nunavut. What was the city's former name, and who was it named after?", year: null,
    eric: { options: ["Frobisher Bay — named after Sir Martin Frobisher, the 1570s Arctic explorer", "Fort Baker — named after a Hudson's Bay Company factor", "Franklin Bay — named after Sir John Franklin", "Foxe Basin — named after Luke Foxe"], correct: 0, explanation: "Frobisher Bay — the FB in YFB. Named after Sir Martin Frobisher, who explored the area in the 1570s searching for the Northwest Passage. The city was renamed Iqaluit (Inuktitut for 'place of many fish') on 1 January 1987. It became the capital of the new territory of Nunavut on 1 April 1999." },
    ruth: { options: ["Frobisher Bay — named after an Arctic explorer!", "Frobisher Bay — named after an Arctic explorer!", "Now called Iqaluit (place of many fish)", "Eric has never been to Nunavut"], correct: 0, explanation: "Frobisher Bay! Named after a 1570s explorer. Now Iqaluit — Inuktitut for 'place of many fish.'" } },
  { id: 660, category: "canada-airports", question: "Gander Airport (YQX) in Newfoundland became world-famous after 9/11. What happened?", year: 2001,
    eric: { options: ["38 transatlantic flights were diverted there when US airspace closed — 6,600 passengers stranded in a town of 10,000", "It was the first airport to resume transatlantic flights after the attacks", "It served as a staging base for the US military response", "The airport control tower was the first to detect the hijacked aircraft"], correct: 0, explanation: "When US airspace was closed on 11 September 2001 (Operation Yellow Ribbon), 38 aircraft carrying 6,595 passengers were diverted to tiny Gander (population ~10,000). The town's residents housed, fed, and cared for the stranded passengers. The story became the hit Broadway musical 'Come From Away' (2017)." },
    ruth: { options: ["38 planes diverted — 6,600 people in a town of 10,000!", "38 planes diverted — 6,600 people in a town of 10,000!", "They looked after every single person", "It became a Broadway musical!"], correct: 0, explanation: "6,600 passengers stranded in a town of 10,000 — and every one was looked after. It became the musical Come From Away." } },
  { id: 661, category: "canada-airports", question: "Which Canadian airport code sounds like a food item?", year: null,
    eric: { options: ["YAM — Sault Ste. Marie, Ontario", "YEW — Vancouver seaplane terminal", "YAK — Yakutat (that's actually in Alaska, not Canada)", "YAP — Nanaimo harbour"], correct: 0, explanation: "YAM — the code for Sault Ste. Marie Airport in Ontario. Also amusing: YOW (Ottawa — 'Ow!'), YAY (St. Anthony, Newfoundland — 'Yay!'), and the non-existent but wished-for YEH, YEP, and YAK." },
    ruth: { options: ["YAM! Sault Ste. Marie!", "YAM! Sault Ste. Marie!", "An airport that sounds like a vegetable", "Eric would remember this code easily"], correct: 0, explanation: "YAM! The airport that sounds like a sweet potato. Sault Ste. Marie, Ontario." } },
  { id: 662, category: "canada-airports", question: "How many airports does Canada have approximately, and where does this rank globally?", year: null,
    eric: { options: ["Approximately 1,425 — 5th in the world", "Approximately 500 — 15th in the world", "Approximately 3,000 — 2nd in the world", "Approximately 800 — 8th in the world"], correct: 0, explanation: "Approximately 1,425 airports — 5th globally. Canada's vast distances, sparse population, and remote northern communities make aviation essential. Many communities in the Arctic are accessible only by air (or seasonal ice road). The US leads with over 13,000." },
    ruth: { options: ["About 1,425 — 5th in the world!", "About 1,425 — 5th in the world!", "A LOT of airports for 40 million people", "Eric hasn't been to all of them"], correct: 0, explanation: "Nearly 1,500 airports! Fifth most in the world. Many Arctic communities can only be reached by air." } },
  { id: 663, category: "canada-airports", question: "Not all Canadian airport codes start with Y. What other prefixes exist?", year: null,
    eric: { options: ["Some start with Z (e.g., ZBF Bathurst, ZSJ Sandy Lake) and a few start with other letters", "All Canadian codes start with Y without exception", "Some start with C for 'Canada'", "Codes starting with X are used for military airfields"], correct: 0, explanation: "Some Canadian airports have codes starting with Z (ZBF = Bathurst, NB; ZSJ = Sandy Lake, ON; ZKE = Kaschechewan, ON) and occasionally other letters. The Y prefix is dominant but not universal. The Z codes tend to be for smaller, more remote airports." },
    ruth: { options: ["Some start with Z!", "Some start with Z!", "Not ALL Canadian codes start with Y", "Eric is surprised (so are most people)"], correct: 0, explanation: "Some start with Z! The Y rule isn't absolute. Bathurst, Sandy Lake, and others break the pattern." } },
  { id: 664, category: "canada-airports", question: "YVR is Vancouver. What does YUL stand for, and which city is it?", year: null,
    eric: { options: ["Montreal (Pierre Elliott Trudeau Airport) — UL was the old 2-letter station code", "Quebec City — from 'Université Laval'", "Longueuil — a Montreal suburb", "Laval — north of Montreal"], correct: 0, explanation: "Montreal — Pierre Elliott Trudeau International Airport. UL was the old 2-letter weather station identifier for the Dorval area (now part of Montreal). The airport was renamed after former PM Trudeau in 2004. Previously known as Montreal-Dorval Airport." },
    ruth: { options: ["Montreal!", "Montreal!", "Named after a Prime Minister", "Eric has been to Montreal (has he?)"], correct: 0, explanation: "Montreal! Previously Dorval Airport, now Pierre Elliott Trudeau Airport. The UL is from the old station code." } },
  { id: 665, category: "canada-airports", question: "YXE is the code for which Canadian city? (Hint: it's in Saskatchewan)", year: null,
    eric: { options: ["Saskatoon (John G. Diefenbaker Airport)", "Swift Current", "Estevan", "Prince Albert"], correct: 0, explanation: "Saskatoon — John G. Diefenbaker International Airport, named after the 13th Prime Minister of Canada (who was from Saskatchewan). YXE doesn't have an obvious derivation — the XE doesn't correspond to any obvious abbreviation of Saskatoon." },
    ruth: { options: ["Saskatoon!", "Saskatoon!", "A city with a very fun name", "Eric has never been to Saskatoon (most people haven't)"], correct: 0, explanation: "Saskatoon! Named after a type of berry. The airport is named after a Prime Minister. The code makes no sense." } },
  { id: 666, category: "canada-airports", question: "Which Neil Peart-related fact connects to YYZ?", year: 2020,
    eric: { options: ["Peart (Rush's drummer) co-wrote the YYZ instrumental and died on 7 January 2020 — the song's Morse code rhythm became a tribute", "Peart was born at Toronto Pearson Airport", "Peart's drumsticks were made from wood grown near the airport", "Peart once landed a plane at YYZ during a Rush concert"], correct: 0, explanation: "Neil Peart co-wrote 'YYZ' with Geddy Lee — its opening rhythm is Morse code for Y-Y-Z. After Peart's death on 7 January 2020 (aged 67, from brain cancer), fans tapped the YYZ rhythm as a tribute. There were campaigns to rename Toronto Pearson's Terminal 3 after him." },
    ruth: { options: ["Rush's drummer co-wrote it — fans tapped the rhythm as a tribute!", "Rush's drummer co-wrote it — fans tapped the rhythm as a tribute!", "A drummer honoured through Morse code", "Eric taps the rhythm too (he doesn't)"], correct: 0, explanation: "Neil Peart died in 2020 and fans tapped the YYZ Morse rhythm as a tribute. A drummer honoured in dots and dashes." } },
  { id: 667, category: "canada-airports", question: "YYC is Calgary. What major annual event is Calgary famous for?", year: null,
    eric: { options: ["The Calgary Stampede (the 'Greatest Outdoor Show on Earth' — rodeo and exhibition)", "The Calgary Film Festival", "The Calgary Marathon (world's coldest marathon)", "The Calgary Science Fair (world's largest)"], correct: 0, explanation: "The Calgary Stampede — billed as 'The Greatest Outdoor Show on Earth.' A 10-day rodeo, exhibition, and festival held every July since 1912. Over 1 million visitors annually. Calgary's airport handles about 18 million passengers per year." },
    ruth: { options: ["The Calgary Stampede!", "The Calgary Stampede!", "Cowboys in Canada", "Eric has never been to a rodeo"], correct: 0, explanation: "The Calgary Stampede! 'The Greatest Outdoor Show on Earth' — a 10-day rodeo every July since 1912." } },
  { id: 668, category: "canada-airports", question: "YHZ is Halifax. The HZ in the code derives from what?", year: null,
    eric: { options: ["The old 2-letter station code HZ — likely from HalifaX (with Z representing the trailing sound)", "HZ stands for 'Harbour Zone'", "HZ honours Herbert Zanuck, a local aviation pioneer", "It's random — no known derivation"], correct: 0, explanation: "HZ was Halifax's old 2-letter weather station identifier. The exact derivation isn't officially documented, but it likely represents HalifaX with the Z capturing the terminal consonant. Similarly, WG = WinniepeG, OW = OttaWa, EG = EdmontonG(?). Not all derivations are perfectly logical." },
    ruth: { options: ["From the old station code HZ — probably HalifaX!", "From the old station code HZ — probably HalifaX!", "Not all codes make perfect sense", "Eric accepts this explanation"], correct: 0, explanation: "HZ from HalifaX! The Z probably represents the end of the name. Canadian airport codes aren't always logical." } },
  { id: 669, category: "canada-airports", question: "YQB is the code for which historic Canadian city?", year: null,
    eric: { options: ["Quebec City (Jean Lesage International Airport)", "Quesnel, British Columbia", "Qu'Appelle, Saskatchewan", "Quinte West, Ontario"], correct: 0, explanation: "Quebec City — Jean Lesage International Airport. Named after Jean Lesage, Premier of Quebec 1960-1966, who led the 'Quiet Revolution.' Quebec City is one of the oldest European settlements in North America (founded by Samuel de Champlain in 1608). The old walled city is a UNESCO World Heritage Site." },
    ruth: { options: ["Quebec City!", "Quebec City!", "One of the oldest cities in North America", "Eric should visit (it's beautiful)"], correct: 0, explanation: "Quebec City! Founded 1608, walled old town, UNESCO World Heritage Site. A gorgeous city." } },
  { id: 670, category: "canada-airports", question: "YZF is the code for which territorial capital?", year: null,
    eric: { options: ["Yellowknife, Northwest Territories", "Yellowknife, Yukon", "Faro, Yukon", "Fort Nelson, British Columbia"], correct: 0, explanation: "Yellowknife — capital of the Northwest Territories since 1967. Population about 20,000. Named after the Yellowknives Dene First Nation, who made tools from local copper deposits. The airport is the main gateway to the NWT — famous for Northern Lights viewing." },
    ruth: { options: ["Yellowknife!", "Yellowknife!", "Capital of the Northwest Territories", "Eric has seen the Northern Lights (has he?)"], correct: 0, explanation: "Yellowknife! Named after a First Nation who made copper tools. Famous for the Northern Lights." } },
  { id: 671, category: "canada-airports", question: "YWG is Winnipeg. What was Winnipeg's airport famous for before the jet age?", year: null,
    eric: { options: ["A major refuelling stop for transatlantic flights — the 'Crossroads of Canada'", "The first airport in Canada to have a paved runway", "The only Canadian airport with a revolving control tower", "Canada's first international departure point"], correct: 0, explanation: "Winnipeg was the 'Crossroads of Canada' — a vital refuelling stop for east-west and transatlantic flights before long-range jets made direct routes possible. Its central geographic position made it a natural stopping point. WG was the old weather station code, likely from WinniPeG." },
    ruth: { options: ["A refuelling stop — the 'Crossroads of Canada'!", "A refuelling stop — the 'Crossroads of Canada'!", "Right in the middle of the country", "Eric has refuelled there (metaphorically)"], correct: 0, explanation: "The Crossroads of Canada! Every flight had to stop in Winnipeg to refuel before jets could fly coast-to-coast." } },

  // ─── Aberdeen FC ──────────────────────────────────────────────
  { id: 672, category: "aberdeen-fc", question: "What does 'Pittodrie' mean in Gaelic?", year: null,
    eric: { options: ["'Hill of dung' — it was a former police horse dung hill", "'Field of victory'", "'Gathering place of the clans'", "'Flat ground by the river'"], correct: 0, explanation: "'Hill of dung' — the site was literally a former dung hill for police horses. Opened 2 September 1899. Not the most glamorous origin for a ground that hosted European glory." },
    ruth: { options: ["Hill of dung!", "Hill of dung!", "A manure heap became a football ground", "Eric's stadium is named after poo"], correct: 0, explanation: "Hill of dung! A police horse manure heap became one of Scotland's most famous football grounds." } },
  { id: 673, category: "aberdeen-fc", question: "What was invented at Pittodrie that is now used at every football ground in the world?", year: 1931,
    eric: { options: ["The dugout — by trainer Donald Colman, who wanted to study players' footwork from below pitch level", "Floodlights", "The electronic scoreboard", "Heated pitches"], correct: 0, explanation: "The dugout! Donald Colman designed a sunken bench below pitch level to study players' feet. Inspired by his time coaching SK Brann in Bergen, Norway. Everton visited, liked the idea, and took it to England. Now every ground in the world has them." },
    ruth: { options: ["The dugout!", "The dugout!", "Invented at Pittodrie!", "Now used everywhere"], correct: 0, explanation: "The dugout was invented at Pittodrie! A sunken bench to watch players' feet. Now used worldwide." } },
  { id: 674, category: "aberdeen-fc", question: "Pittodrie achieved what UK first in 1978?", year: 1978,
    eric: { options: ["First all-seater stadium in Britain", "First with undersoil heating", "First with CCTV", "First with electronic turnstiles"], correct: 0, explanation: "First all-seater stadium in Britain — years before the Taylor Report (1989). By 1981 it was also the UK's first all-covered, all-seater stadium." },
    ruth: { options: ["First all-seater in Britain!", "First all-seater in Britain!", "Before anyone else", "Eric sat down before it was fashionable"], correct: 0, explanation: "First all-seater in the UK! Before it was compulsory." } },
  { id: 675, category: "aberdeen-fc", question: "Who scored Aberdeen's winner in the 1983 European Cup Winners' Cup final vs Real Madrid, and when?", year: 1983,
    eric: { options: ["John Hewitt, 112th minute — a header, after coming on as sub in the 87th minute", "Gordon Strachan, 89th minute — a free kick", "Eric Black, 105th minute — a tap-in", "Mark McGhee, 118th minute — a diving header"], correct: 0, explanation: "John Hewitt — the ultimate super-sub. On for Eric Black in the 87th minute, scored in the 112th. Black had opened the scoring (7th), Juanito equalised via penalty (15th). Torrential rain in Gothenburg, 17,804 crowd at Nya Ullevi." },
    ruth: { options: ["John Hewitt! Super-sub! 112th minute!", "John Hewitt! Super-sub! 112th minute!", "Beat Real Madrid in the rain", "Eric was there (was he?)"], correct: 0, explanation: "John Hewitt — came on as sub and headed the winner against Real Madrid in torrential rain!" } },
  { id: 676, category: "aberdeen-fc", question: "Aberdeen hold what unique record against Real Madrid?", year: 1983,
    eric: { options: ["100% record — played once, won once. Real have never beaten Aberdeen", "Most goals scored against Real in a single European match", "Only Scottish club to face Real in a final", "Youngest squad ever to face Real"], correct: 0, explanation: "Played 1, Won 1, Drew 0, Lost 0. Real Madrid have never beaten Aberdeen. It was also the last time Real lost a major European final — a record that stood for decades." },
    ruth: { options: ["Real Madrid have NEVER beaten Aberdeen!", "Real Madrid have NEVER beaten Aberdeen!", "Played 1, Won 1", "Eric is very proud of this"], correct: 0, explanation: "100% record! Real have never beaten Aberdeen. One game, one win. That's all that matters." } },
  { id: 677, category: "aberdeen-fc", question: "In the 1983 Super Cup, Neil Simpson man-marked which famous Hamburg captain out of the game?", year: 1983,
    eric: { options: ["Felix Magath (who scored Hamburg's European Cup final winner vs Juventus)", "Franz Beckenbauer", "Kevin Keegan", "Horst Hrubesch"], correct: 0, explanation: "Felix Magath. Aberdeen won 2-0 at Pittodrie (0-0 first leg). Goals from Simpson (47th) and McGhee (65th). First Scottish club to win the European Super Cup." },
    ruth: { options: ["Felix Magath!", "Felix Magath!", "Completely shut him down", "Aberdeen: European Super Cup winners"], correct: 0, explanation: "Felix Magath — shut down by Neil Simpson. Aberdeen became the first Scottish club to win the Super Cup." } },
  { id: 678, category: "aberdeen-fc", question: "Willie Miller holds Aberdeen's appearance record. How many games?", year: null,
    eric: { options: ["796", "650", "720", "850"], correct: 0, explanation: "796 appearances (1972-1990). Ferguson called him 'the best penalty box defender in the world.' 65 Scotland caps. Voted greatest Aberdeen player ever in the 2003 centenary poll. McLeish is second with 692." },
    ruth: { options: ["796!", "796!", "The greatest Don", "Nearly 800 games for one club"], correct: 0, explanation: "796 games! Nearly 800 for one club. The greatest Aberdeen player ever." } },
  { id: 679, category: "aberdeen-fc", question: "Zoltan Varga played one season at Pittodrie. What made his arrival unusual?", year: 1972,
    eric: { options: ["He was an Olympic gold medallist banned from German football for bribery", "He defected from Hungary by hiding in the team bus", "He was signed from a prison football team", "He arrived disguised as a tourist and was spotted at a local match"], correct: 0, explanation: "Olympic gold (1964 Tokyo) with Hungary, banned from the Bundesliga for bribery. Aberdeen signed him for £40,000. 31 appearances, 10 goals. George Best reportedly needed 'a stiff drink' after Varga's masterclass against Man Utd at Pittodrie." },
    ruth: { options: ["Olympic champion banned for bribery!", "Olympic champion banned for bribery!", "Even George Best was impressed", "One magical season"], correct: 0, explanation: "An Olympic champion banned from German football landed at Pittodrie! George Best was shaken by his skill." } },
  { id: 680, category: "aberdeen-fc", question: "Aberdeen were the first club ever eliminated from European competition by penalty shootout. What went wrong?", year: 1970,
    eric: { options: ["1970 vs Honved — the referee didn't know shootouts existed and tried to arrange a third match", "1968 vs Real Madrid — the goalkeeper was sent off", "1975 vs Bayern — they missed five consecutive penalties", "1983 vs Juventus — the referee forgot to count"], correct: 0, explanation: "1970-71 Cup Winners' Cup vs Honved. After 4-4 on aggregate, the referee tried to arrange a third match — he didn't know the new penalty shootout rule! A European observer had to inform him. Jim Forrest hit the bar with the crucial kick. The Honved keeper scored the winner." },
    ruth: { options: ["The referee didn't know the rules!", "The referee didn't know the rules!", "First ever shootout elimination", "Even the ref was confused"], correct: 0, explanation: "The referee tried to arrange a third match! He didn't know shootouts existed. Aberdeen made history the wrong way." } },
  { id: 681, category: "aberdeen-fc", question: "Ferguson won 10 trophies in 8 years at Aberdeen. How many league titles?", year: 1986,
    eric: { options: ["3 (1980, 1984, 1985)", "2 (1980, 1984)", "4 (1980, 1983, 1984, 1985)", "1 (1984)"], correct: 0, explanation: "Three: 1979-80, 1983-84, 1984-85. The 1980 title was the first by a club outside the Old Firm since Kilmarnock in 1965. Plus 4 Scottish Cups, 1 League Cup, the ECWC, and the Super Cup. He left for Man Utd on 6 November 1986." },
    ruth: { options: ["Three!", "Three!", "Breaking 15 years of Old Firm dominance", "Then he went to Man Utd"], correct: 0, explanation: "Three league titles! The first broke 15 years of Old Firm dominance." } },
  { id: 682, category: "aberdeen-fc", question: "Before wearing red, Aberdeen wore black and gold for 35 years. What were they nicknamed?", year: 1939,
    eric: { options: ["The Wasps", "The Bees", "The Tigers", "The Hornets"], correct: 0, explanation: "The Wasps! 1904-1939 in black and gold stripes. Last wasp match: 29 April 1939 (2-0 vs Rangers). First red match: 12 August 1939 (3-1 vs Celtic). Their 2024-25 away kit was a heritage 'Wasp Kit.'" },
    ruth: { options: ["The Wasps!", "The Wasps!", "Black and gold for 35 years", "Now they're the Reds"], correct: 0, explanation: "The Wasps! Black and gold stripes for 35 years before switching to red." } },
  { id: 683, category: "aberdeen-fc", question: "Joe Harper holds Aberdeen's all-time scoring record. How close to 200 goals did he get?", year: null,
    eric: { options: ["199 — one short", "200 exactly", "195", "187"], correct: 0, explanation: "199 goals — agonisingly one short! 'King Joey.' Two spells (1969-72, 1976-81). Best season: 33 in 34 league games (1971-72)." },
    ruth: { options: ["199! One short of 200!", "199! One short of 200!", "King Joey", "So close to the double century"], correct: 0, explanation: "199! One goal short of 200. Known as King Joey — Aberdeen's greatest striker." } },
  { id: 684, category: "aberdeen-fc", question: "Aberdeen only exist because which Edinburgh club threatened to relocate to Aberdeen in 1902?", year: 1903,
    eric: { options: ["Hibernian", "Hearts", "Leith Athletic", "Edinburgh City"], correct: 0, explanation: "Hibernian considered relocating to Aberdeen in 1902 and even sent a valuer to Pittodrie. This prompted three local clubs (Aberdeen, Victoria United, Orion) to merge on 14 April 1903. Over 1,600 citizens attended the public meeting." },
    ruth: { options: ["Hibernian!", "Hibernian!", "Three clubs merged in self-defence", "Without Hibs' threat, no Aberdeen FC"], correct: 0, explanation: "Hibs nearly moved to Aberdeen! Three local clubs panicked and merged. Without that threat, no Dons." } },
  { id: 685, category: "aberdeen-fc", question: "Aberdeen are the only Scottish club to display what on their badge?", year: 2005,
    eric: { options: ["Two European trophy stars (ECWC and Super Cup, both 1983)", "A crown", "A ship", "Three lions"], correct: 0, explanation: "Two stars for the 1983 European Cup Winners' Cup and 1983 Super Cup. No other Scottish club has won two European trophies. Added to the badge in 2005-06." },
    ruth: { options: ["Two European trophy stars!", "Two European trophy stars!", "No other Scottish club has this", "Eric is very proud"], correct: 0, explanation: "Two stars! No other Scottish club can match Aberdeen's two European trophies." } },
  { id: 686, category: "aberdeen-fc", question: "The 'New Firm' was the 1980s rivalry between Aberdeen and which club?", year: null,
    eric: { options: ["Dundee United", "St Johnstone", "Inverness", "Hearts"], correct: 0, explanation: "Dundee United. Both simultaneously challenged the Old Firm — three consecutive league titles (1983-85) went to either Aberdeen or United. The only period where two non-Glasgow clubs dominated Scottish football." },
    ruth: { options: ["Dundee United!", "Dundee United!", "The New Firm broke the Old Firm", "A golden age for northeast football"], correct: 0, explanation: "Dundee United! Both clubs dominated at the same time. The New Firm vs the Old Firm." } },

  // ─── Forfar Athletic FC ───────────────────────────────────────
  { id: 687, category: "forfar-fc", question: "Station Park is named after a railway station. Why is this now ironic?", year: 1967,
    eric: { options: ["Forfar station closed on 4 September 1967 (Beeching cuts) — no station for nearly 60 years", "The station was converted into the club shop", "The station moved to the other side of town", "The name was always a joke — there was never a station"], correct: 0, explanation: "Forfar station closed 4 September 1967. Nearest stations: Dundee and Arbroath (~14 miles each). Station Park is named after a ghost station. Record attendance: 10,780 vs Rangers, 7 February 1970." },
    ruth: { options: ["The station closed in 1967!", "The station closed in 1967!", "Named after something that doesn't exist", "Eric knew this"], correct: 0, explanation: "The station closed in 1967! Station Park is named after a ghost." } },
  { id: 688, category: "forfar-fc", question: "'East Fife four, Forfar five' — who made this scoreline famous?", year: 1964,
    eric: { options: ["Eric Morecambe — his greeting to BBC results reader James Alexander Gordon for 20 years", "Monty Python — in a sketch", "Billy Connolly — in his stand-up act", "Archie Macpherson — during a live BBC commentary"], correct: 0, explanation: "Eric Morecambe greeted James Alexander Gordon with 'East Fife four, Forfar five' for 20+ years. It actually happened: 22 April 1964 (Second Division). Then on 22 July 2018, it happened again — on penalties in the League Cup! The football world celebrated." },
    ruth: { options: ["Eric Morecambe!", "Eric Morecambe!", "His greeting to the results reader for 20 years", "It actually happened — twice!"], correct: 0, explanation: "Eric Morecambe! He said it to the BBC results man for decades. And it actually happened — in 1964 and 2018." } },
  { id: 689, category: "forfar-fc", question: "Forfar's Archie Knox (player-manager 1976-80) became assistant to which legendary manager?", year: 1980,
    eric: { options: ["Alex Ferguson — at Aberdeen then Manchester United", "Jock Stein", "Bill Shankly", "Brian Clough"], correct: 0, explanation: "Alex Ferguson! Knox's success at Station Park led Ferguson to hire him as assistant at Aberdeen in 1980. They won the ECWC (1983), Super Cup, and Scottish cups. Knox followed Ferguson to Man Utd. One of football's greatest partnerships started at Forfar." },
    ruth: { options: ["Alex Ferguson!", "Alex Ferguson!", "From Forfar to European glory", "The greatest partnership started at Station Park"], correct: 0, explanation: "Alex Ferguson! From tiny Forfar to beating Real Madrid. Football's greatest partnership was born here." } },
  { id: 690, category: "forfar-fc", question: "Forfar's record win is 14-1 (1888). How many goals came in the first half?", year: 1888,
    eric: { options: ["11", "8", "7", "14 (it was all first half)"], correct: 0, explanation: "11 goals in the first half! Against Lindertis from nearby Kirriemuir, 1 September 1888. The second half was a mere 3-1. Record defeat: 2-12 vs King's Park, 2 January 1930." },
    ruth: { options: ["ELEVEN!", "ELEVEN!", "11 goals before half-time", "Poor Lindertis"], correct: 0, explanation: "Eleven goals before the break! Poor Lindertis from Kirriemuir. The second half was almost gentle by comparison." } },
  { id: 691, category: "forfar-fc", question: "Forfar FP Alec Troup assisted Dixie Dean's record 60th league goal. How?", year: 1928,
    eric: { options: ["He swung in the corner from which Dean headed the goal vs Arsenal, 5 May 1928", "He passed through the entire Arsenal defence", "He took the free kick that Dean headed in", "He scored 59 of the goals himself and Dean only got the last one"], correct: 0, explanation: "'Wee Troupie' — from Forfar, signed by Everton for £4,000 in 1923. Ever-present in Everton's 1927-28 title. He delivered the corner for Dean's record-breaking 60th goal against Arsenal. A Forfar loon set up the most famous goal in English football history." },
    ruth: { options: ["He crossed the corner for the 60th goal!", "He crossed the corner for the 60th goal!", "A Forfar boy set up Dixie Dean", "Football history made by a Loon"], correct: 0, explanation: "A Forfar lad crossed the ball for the most famous goal in English football! Troup's corner, Dean's header." } },
  { id: 692, category: "forfar-fc", question: "How close did Forfar get to the top division in their centenary season (1985-86)?", year: 1986,
    eric: { options: ["Finished one point below promotion", "Lost a promotion playoff on penalties", "Won the division but were denied on ground criteria", "Finished mid-table"], correct: 0, explanation: "One point! Agonisingly close in their 100th birthday year under Doug Houston. Forfar have NEVER played in the top flight of Scottish football. The previous season, Houston won the Second Division by 16 points." },
    ruth: { options: ["ONE point short!", "ONE point short!", "In their centenary year", "Football can be cruel"], correct: 0, explanation: "One single point! In their 100th birthday year. Forfar have never reached the top division." } },
  { id: 693, category: "forfar-fc", question: "The Forfar witch trials (1661-62): in a town of ~1,000 people, how many were accused?", year: 1661,
    eric: { options: ["At least 53 accused, 22 women executed", "12 accused, 3 executed", "About 100 accused, 50 executed", "5 accused, all acquitted"], correct: 0, explanation: "53 accused, 42 imprisoned and tortured, 22 women executed — in a town of about 1,000. Over 4% of the population accused, 2% executed. One of the most intense witch persecutions relative to population in Scottish history." },
    ruth: { options: ["53 accused, 22 executed!", "53 accused, 22 executed!", "In a town of just 1,000", "A terrible chapter"], correct: 0, explanation: "53 accused in a town of 1,000! 22 women executed. One of Scotland's worst witch persecutions." } },

  // ─── Combs ────────────────────────────────────────────────────
  { id: 694, category: "combs", question: "The comb-over was patented in 1977. What is the patent number?", year: 1977,
    eric: { options: ["US Patent 4,022,227 — by Donald J. Smith and Frank J. Smith, complete with diagrams", "US Patent 3,141,592 — by Harold Bald of New Jersey", "It was never patented — it's too old", "UK Patent 1977-COMB-001"], correct: 0, explanation: "US Patent 4,022,227! Donald and Frank Smith patented 'a method of styling hair to cover partial baldness' with technical diagrams. Expired 1998. The most optimistic patent ever filed." },
    ruth: { options: ["US Patent 4,022,227!", "US Patent 4,022,227!", "Someone actually PATENTED the comb-over", "Eric doesn't need one (does he?)"], correct: 0, explanation: "Someone patented the comb-over! With diagrams! The patent of eternal hope." } },
  { id: 695, category: "combs", question: "The oldest known sentence in the Canaanite alphabet was found on a comb. What does it say?", year: null,
    eric: { options: ["'May this tusk root out the lice of the hair and the beard' (c.1700 BCE, Lachish)", "'Comb your hair every morning for fortune'", "'This comb belongs to the king'", "'Made by the master comb-maker of Lachish'"], correct: 0, explanation: "Found at Tel Lachish, Israel (published 2022 by Hebrew University). About 3,700 years old. Microscopic analysis found actual head lice remains on the comb. The oldest alphabet sentence — about nit combing." },
    ruth: { options: ["It's about removing lice!", "It's about removing lice!", "3,700 years old and about nits", "Some things never change"], correct: 0, explanation: "The oldest sentence ever written in alphabetic script is about getting rid of nits! They found actual lice on the comb." } },
  { id: 696, category: "combs", question: "Why were celluloid combs genuinely dangerous?", year: null,
    eric: { options: ["Celluloid is chemically similar to guncotton — highly flammable near gas lamps or candles", "Teeth snapped off and were swallowed", "Lead dyes leached into scalps", "Static could cause burns"], correct: 0, explanation: "Celluloid (cellulose nitrate) is chemically similar to guncotton. Women's hair ornaments caught fire near gas lamps and candles, causing injuries and fatalities. Old celluloid combs in museums can still spontaneously combust. Replaced by cellulose acetate from the 1940s." },
    ruth: { options: ["They could catch FIRE!", "They could catch FIRE!", "Similar to explosives", "Eric's comb is plastic (much safer)"], correct: 0, explanation: "Chemically similar to explosives! Women's hair combs bursting into flames near candles." } },
  { id: 697, category: "combs", question: "Aberdeen was a major centre for comb manufacturing. From what material?", year: null,
    eric: { options: ["Cattle horn — heated, flattened, and cut", "Tortoiseshell", "Whalebone", "Granite"], correct: 0, explanation: "Cattle horn. Aberdeen's horn comb industry peaked in the late 18th to mid-19th century, concentrated in the Gallowgate area. Horns were sawn, soaked, heated, pressed flat, then cut. Killed off by vulcanite and celluloid." },
    ruth: { options: ["Horn! Cattle horn!", "Horn! Cattle horn!", "Aberdeen's Gallowgate was full of comb workshops", "Eric's city had a comb industry"], correct: 0, explanation: "Cattle horn! The Gallowgate was full of comb workshops. Cheap plastics killed the industry." } },
  { id: 698, category: "combs", question: "'Tortoiseshell' combs aren't from tortoises. What animal are they from?", year: null,
    eric: { options: ["The hawksbill sea turtle (critically endangered, CITES banned since 1973)", "The giant land tortoise", "A synthetic resin", "Dyed ox horn"], correct: 0, explanation: "The hawksbill sea turtle — critically endangered. The shell is keratin (same as fingernails). Banned under CITES since 1973. Japan didn't comply until 1992." },
    ruth: { options: ["A sea TURTLE, not a tortoise!", "A sea TURTLE, not a tortoise!", "Now critically endangered", "Eric's comb is plastic"], correct: 0, explanation: "A sea turtle! Critically endangered, banned internationally since 1973." } },
  { id: 699, category: "combs", question: "Viking men were obsessive groomers. What did an Anglo-Saxon chronicler complain about?", year: null,
    eric: { options: ["Vikings were stealing English women because they combed daily, bathed weekly, and changed clothes", "Vikings were too ugly to attract anyone", "Vikings refused to share their combs", "Vikings used combs as weapons"], correct: 0, explanation: "John of Wallingford complained Viking men stole English women because they combed their hair daily, bathed weekly (Saturdays — 'laugardagr' = 'washing day'), and changed clothes regularly. Comb finds are among the most common at Viking sites." },
    ruth: { options: ["Too handsome — stealing English women!", "Too handsome — stealing English women!", "Daily combing and weekly bathing", "Anglo-Saxon men couldn't compete"], correct: 0, explanation: "Vikings were too well-groomed! The English women preferred them." } },
  { id: 700, category: "combs", question: "What was the universal playground nickname for the school nit nurse?", year: null,
    eric: { options: ["'Nitty Nora the head explorer'", "'Lousy Lucy'", "'Nit-picking Nelly'", "'Scratchy Sandra'"], correct: 0, explanation: "'Nitty Nora the head explorer' — every child in Britain knew this name. The school health visitor checked heads for lice. Service largely discontinued in the 1990s." },
    ruth: { options: ["Nitty Nora the head explorer!", "Nitty Nora the head explorer!", "Every child knew this name", "Eric was inspected by Nitty Nora"], correct: 0, explanation: "Nitty Nora! The most feared woman in primary school." } },
  { id: 701, category: "combs", question: "In Happy Days, the Fonz had a running gag with his comb. What was it?", year: null,
    eric: { options: ["He'd pull it out, look in the mirror, realise his hair was already perfect, and put it away", "He combed for exactly 60 seconds every scene", "He threw it in the air and caught it behind his back", "He used a gold comb given by Elvis"], correct: 0, explanation: "He'd pull out his pocket comb, look in the mirror, realise his hair was already perfect, and put it away. The gag ran from 1974-1984. The coolest man on television didn't need a comb." },
    ruth: { options: ["His hair was already perfect!", "His hair was already perfect!", "Too cool for a comb", "Eric's hair is also always perfect (is it?)"], correct: 0, explanation: "He'd look in the mirror and put the comb away. Already perfect! The Fonz: too cool to comb." } },
  { id: 702, category: "combs", question: "Playing a comb and tissue paper as a musical instrument — what type of instrument is this?", year: null,
    eric: { options: ["A membranophone (the paper is the vibrating membrane)", "An idiophone", "An aerophone", "A chordophone"], correct: 0, explanation: "A membranophone — the tissue paper is the vibrating membrane, like a kazoo. Press lips to the paper-covered comb and hum. Used in jug bands and skiffle groups. The cheapest instrument ever made." },
    ruth: { options: ["A membranophone!", "A membranophone!", "Like a free kazoo", "Eric played comb and paper as a child"], correct: 0, explanation: "A membranophone! The world's cheapest musical instrument." } },
  { id: 703, category: "combs", question: "Leominster, Massachusetts was known as what, due to its comb industry?", year: null,
    eric: { options: ["'Comb City'", "'The City of Teeth'", "'Brush Town'", "'The Celluloid Capital'"], correct: 0, explanation: "'Comb City' — dominated US comb production. Started with horn, moved to celluloid, then plastics. Similarly, Oyonnax in France built its economy on combs and became France's 'Plastics Valley.'" },
    ruth: { options: ["Comb City!", "Comb City!", "A whole city built on combs", "Eric has never been"], correct: 0, explanation: "Comb City! A whole American city built on making combs." } },
  { id: 704, category: "combs", question: "Why do plastic combs create static in hair but horn combs don't?", year: null,
    eric: { options: ["The triboelectric effect — plastic strips electrons from hair; horn is neutral on the triboelectric series", "Plastic is smoother and creates friction heat", "Horn absorbs static into its fibres", "Plastic has chemical additives that ionise air"], correct: 0, explanation: "The triboelectric effect: plastic strips electrons from hair, creating opposite charges. Horn, wood, and vulcanite are near-neutral on the triboelectric series, so they don't create static. That's why they were marketed as 'anti-static.'" },
    ruth: { options: ["The triboelectric effect!", "The triboelectric effect!", "Plastic steals electrons", "Horn and wood don't"], correct: 0, explanation: "Plastic steals electrical charges from your hair! Horn and wood don't. Science explains bad hair days." } },
  { id: 705, category: "combs", question: "Japanese tsuge-gushi combs undergo what unusual preparation?", year: null,
    eric: { options: ["Boxwood treated with camellia oil for years before carving", "Soaked in sake for six months", "Buried underground for a decade", "Smoked over cherry wood fires"], correct: 0, explanation: "Treated with camellia oil for years — sometimes decades — before carving. Made in Kibi, Wakayama Prefecture. Boxwood creates no static, distributes natural oils, and is gentle. Tsuge-gushi are passed down as family heirlooms." },
    ruth: { options: ["Oiled for YEARS before carving!", "Oiled for YEARS before carving!", "The most pampered wood in the world", "Worth the wait"], correct: 0, explanation: "Soaked in oil for years! Japanese craftsmanship at its finest." } },
  { id: 706, category: "combs", question: "René Lalique's Art Nouveau combs have sold at auction for how much?", year: null,
    eric: { options: ["Over $100,000 — gold, enamel, horn, and precious stones", "About $5,000", "About $500", "Over $1 million"], correct: 0, explanation: "Over $100,000! Lalique combs (c.1890-1910) combine gold, enamel, horn, and semi-precious stones with dragonflies, flowers, and female figures. Serious works of art that happen to be combs." },
    ruth: { options: ["Over $100,000!", "Over $100,000!", "For a COMB!", "Eric's cost considerably less"], correct: 0, explanation: "Over a hundred thousand dollars! Made with gold and precious stones. Slightly more than Boots charges." } },

  // ─── Dilbert ──────────────────────────────────────────────────
  { id: 707, category: "dilbert", question: "Why does Dilbert's tie curl upward?", year: null,
    eric: { options: ["Adams said it symbolises Dilbert's complete lack of power — it defies gravity because he controls nothing", "It's caught in the air conditioning vent above his cubicle", "It represents his engineering creativity trying to escape", "Adams simply can't draw ties properly"], correct: 0, explanation: "It symbolises Dilbert's lack of power. Adams said the tie defies gravity because Dilbert has no control over anything in his life. It started as a drawing quirk but became iconic — like Dilbert himself, it's trapped in a system it can't escape." },
    ruth: { options: ["It symbolises his lack of power!", "It symbolises his lack of power!", "The tie has more freedom than Dilbert", "Eric's tie behaves itself (usually)"], correct: 0, explanation: "His tie curls up because he has no power! Even his clothing rebels against him." } },
  { id: 708, category: "dilbert", question: "The Pointy-Haired Boss's hair sticks up in two points. What do they deliberately represent?", year: null,
    eric: { options: ["Devil horns — symbolising the evil of incompetent management", "Antennae — he's tuning into management fads", "The two sides of every argument he gets wrong", "Stress — his hair stands on end from anxiety"], correct: 0, explanation: "Devil horns. Adams confirmed it was intentional — the PHB is literally drawn as the devil of the corporate world. He has no name (he represents EVERY bad manager), doesn't understand technology, takes credit for others' work, and genuinely believes he's doing a great job." },
    ruth: { options: ["Devil horns!", "Devil horns!", "The devil of management", "Eric has never had a pointy-haired boss (has he?)"], correct: 0, explanation: "Devil horns! Adams drew them deliberately. The Pointy-Haired Boss is literally the devil of corporate life." } },
  { id: 709, category: "dilbert", question: "What is the Dilbert Principle?", year: 1996,
    eric: { options: ["Incompetent workers are promoted to management to get them out of the way — where they can do least damage", "Every employee rises to their level of incompetence", "The most competent workers are given the most thankless tasks", "All meetings expand to fill the time allocated"], correct: 0, explanation: "The Dilbert Principle (1996 book, #1 NYT bestseller): companies promote ALREADY incompetent people to management because that's where they can do the least damage. This inverts the Peter Principle (1969), which says competent people get promoted until they reach a level where they fail." },
    ruth: { options: ["Promote the incompetent to management!", "Promote the incompetent to management!", "The book was a #1 bestseller", "Eric has seen this principle in action"], correct: 0, explanation: "Promote the useless to management! At least there they can't break anything important. #1 bestseller." } },
  { id: 710, category: "dilbert", question: "Catbert's official title in the strip is what?", year: null,
    eric: { options: ["Evil Director of Human Resources", "Chief Happiness Officer", "Vice President of People Operations", "Head of Talent and Culture"], correct: 0, explanation: "'Evil Director of Human Resources' — that's his actual title. A cat who holds the HR position because cats are naturally sadistic and indifferent to suffering — qualities Adams considers perfect for HR. He purrs while delivering bad news. Introduced around 1994." },
    ruth: { options: ["Evil Director of Human Resources!", "Evil Director of Human Resources!", "A cat in charge of HR", "Eric has met real-life Catberts"], correct: 0, explanation: "Evil Director of Human Resources! A cat. Because cats are naturally cruel. Perfect for HR." } },
  { id: 711, category: "dilbert", question: "Wally's deliberate strategy of doing nothing at work was inspired by whom?", year: null,
    eric: { options: ["A real co-worker at Pacific Bell who decided to do as little as possible after being denied a raise", "Adams himself during his final years at the company", "A management textbook Adams read ironically", "Nobody — Wally is entirely fictional"], correct: 0, explanation: "A real person at Pacific Bell! After being denied a raise, this co-worker decided the rational response was to do absolutely nothing while appearing busy. Adams found the strategy so brilliant he immortalised it. Wally is never without his oversized coffee mug — drinking coffee IS his work." },
    ruth: { options: ["A real person at Pacific Bell!", "A real person at Pacific Bell!", "Denied a raise, so stopped working", "Eric has never done this (definitely not)"], correct: 0, explanation: "A real colleague! He was denied a raise and decided to stop working. Adams thought it was genius." } },
  { id: 712, category: "dilbert", question: "Phil, the Prince of Insufficient Light, rules what domain and carries what implement?", year: null,
    eric: { options: ["He rules Heck (not Hell) and carries a giant spoon (not a pitchfork)", "He rules Purgatory and carries a clipboard", "He rules Limbo and carries a rubber stamp", "He rules the basement and carries a flashlight"], correct: 0, explanation: "Phil rules Heck — not Hell (that's for serious sinners). He handles minor corporate sins: stealing office supplies, padding expense reports, using the printer for personal documents. He carries a giant SPOON (a pitchfork would be too serious for Heck). He 'darns' people to Heck (doesn't 'damn' them)." },
    ruth: { options: ["Heck! With a giant spoon!", "Heck! With a giant spoon!", "Not Hell — just Heck", "Eric has been darned to Heck (probably)"], correct: 0, explanation: "He rules Heck with a giant spoon! Not Hell — that's too serious. Phil handles minor office sins. He darns you, not damns you." } },
  { id: 713, category: "dilbert", question: "What is Alice's signature move when enraged?", year: null,
    eric: { options: ["The Fist of Death — a devastating punch that sends people flying across rooms", "The Spreadsheet Slam — hitting someone with a laptop", "The Email of Doom — a passive-aggressive all-staff email", "The Meeting Escape — walking out mid-sentence"], correct: 0, explanation: "The Fist of Death! Alice is arguably the most technically competent person in the department but is overlooked. When sufficiently enraged by sexism, incompetence, or workplace stupidity, she delivers the Fist of Death. Her triangular/cone-shaped hairstyle is as distinctive as the Boss's devil horns." },
    ruth: { options: ["The Fist of Death!", "The Fist of Death!", "Don't make Alice angry", "Eric has never been on the receiving end"], correct: 0, explanation: "The Fist of Death! Alice punches people across rooms when they're stupid enough. Don't provoke her." } },
  { id: 714, category: "dilbert", question: "Mordac's full title is what — and what's the joke?", year: null,
    eric: { options: ["'Preventer of Information Services' — IT exists to PREVENT people from using technology, not help them", "'Provider of Insufficient Technology' — IT gives you outdated equipment", "'Protector of Important Systems' — IT protects systems from users", "'Punisher of Internet Surfers' — IT monitors your browsing"], correct: 0, explanation: "'Preventer of Information Services' — not 'Provider.' The core joke is that the IT department exists to prevent people from accessing technology, not to help them. Mordac denies software requests, enforces absurd password policies, and delights in saying no." },
    ruth: { options: ["PREVENTER — not Provider!", "PREVENTER — not Provider!", "IT exists to say no", "Eric has met real-life Mordacs"], correct: 0, explanation: "Preventer of Information Services! Not provider. IT's job is to stop you using technology. Anyone who's worked in an office knows this." } },
  { id: 715, category: "dilbert", question: "Where did the intern Asok study?", year: null,
    eric: { options: ["IIT (Indian Institute of Technology) — he also has telekinetic powers from meditation", "MIT (Massachusetts Institute of Technology)", "Stanford University", "Caltech"], correct: 0, explanation: "IIT — the Indian Institute of Technology. Asok is brilliant, naive, and idealistic — promptly crushed by corporate reality. In some strips he demonstrates telekinetic powers learned through meditation at IIT. He represents every talented young person whose idealism is destroyed by their first job." },
    ruth: { options: ["IIT in India!", "IIT in India!", "Brilliant but naive", "Eric was once a naive young intern too"], correct: 0, explanation: "IIT! He can also move things with his mind. But he still can't get a decent desk." } },
  { id: 716, category: "dilbert", question: "The Garbage Man in Dilbert has what secret?", year: null,
    eric: { options: ["He is secretly the smartest person in the world — chose garbage collection for freedom from corporate stupidity", "He is an undercover government agent", "He is Dilbert's father in disguise", "He invented the internet but never claimed credit"], correct: 0, explanation: "The smartest person in the world. He can build anything and solve any problem. He chose to be a garbage man because it frees him from corporate idiocy. When Dilbert faces an unsolvable technical problem, the Garbage Man appears as a deus ex machina with the answer." },
    ruth: { options: ["The smartest person in the world!", "The smartest person in the world!", "Chose garbage over cubicles", "Eric would never be that smart... wait"], correct: 0, explanation: "The world's smartest person — who chose to collect bins rather than work in an office. Can you blame him?" } },
  { id: 717, category: "dilbert", question: "What was Dogbert's original name before Adams realised it wouldn't work in newspapers?", year: null,
    eric: { options: ["Dildog", "Dogdil", "Mutbert", "Woofbert"], correct: 0, explanation: "Dildog. Adams quickly realised this wouldn't fly in family newspapers and renamed him Dogbert. Dogbert is a megalomaniac who schemes to rule the world and enslave humanity, frequently reinventing himself as a management consultant who gives terrible advice for enormous fees." },
    ruth: { options: ["Dildog!", "Dildog!", "Obviously couldn't use that in newspapers", "Eric is glad they changed it"], correct: 0, explanation: "Dildog! Imagine that in the family newspaper. Dogbert is much better." } },
  { id: 718, category: "dilbert", question: "Dilbert popularised 'Buzzword Bingo.' What is it?", year: null,
    eric: { options: ["Employees bring bingo cards to meetings, marking off jargon as the boss says it — shout 'Bingo!' when you get a line", "A board game sold by Adams featuring corporate buzzwords", "A website where you can generate random mission statements", "A drinking game played during conference calls"], correct: 0, explanation: "Employees bring bingo cards filled with buzzwords ('synergy,' 'paradigm shift,' 'thinking outside the box,' 'circle back,' 'low-hanging fruit') and mark them off as the boss says them. First popularised in the strip, it became a real-life phenomenon — people actually started playing it in corporate meetings." },
    ruth: { options: ["Bingo cards with buzzwords — shout 'Bingo!' in meetings!", "Bingo cards with buzzwords — shout 'Bingo!' in meetings!", "People actually do this in real life", "Eric has played (he denies it)"], correct: 0, explanation: "Mark off buzzwords as your boss says them! Synergy! Paradigm shift! Low-hanging fruit! BINGO!" } },
  { id: 719, category: "dilbert", question: "Where did Scott Adams work before creating Dilbert?", year: 1995,
    eric: { options: ["Pacific Bell (telephone company) and Crocker National Bank — cubicle jobs that directly inspired the strip", "Microsoft — as a software engineer", "IBM — in the mainframe division", "NASA — as a systems analyst"], correct: 0, explanation: "Pacific Bell and Crocker National Bank. He worked cubicle jobs including bank teller, computer programmer, budget analyst, and technology planner. He drew strips in the office bathroom stalls during work hours. He left Pacific Bell in 1995 when the strip's income exceeded his salary." },
    ruth: { options: ["Pacific Bell and Crocker National Bank!", "Pacific Bell and Crocker National Bank!", "Drew comics in the bathroom at work", "Eric has never drawn comics at work"], correct: 0, explanation: "He worked in cubicles at a bank and a phone company! Drew strips in the toilet during work hours. Living the Dilbert life." } },
  { id: 720, category: "dilbert", question: "How did Adams say managers contributed material to the strip?", year: null,
    eric: { options: ["Managers emailed him stories about 'other managers' — not realising they were describing themselves", "They sent him formal complaints which he used as inspiration", "They hired him as a consultant and he used the meetings as material", "They didn't — he made everything up from pure imagination"], correct: 0, explanation: "Managers would email Adams real stories about corporate dysfunction, apparently not realising they were describing their own incompetence. They thought they were sharing funny stories about OTHER managers. Adams received thousands of 'Are you spying on my company?' messages from office workers." },
    ruth: { options: ["They didn't realise THEY were the joke!", "They didn't realise THEY were the joke!", "Emailed stories about 'other' managers", "Eric knows managers like this"], correct: 0, explanation: "Managers sent in stories about 'other managers' — not realising they were the punchline! Thousands of people asked 'Are you spying on us?'" } },
  { id: 721, category: "dilbert", question: "The fictional country where Dilbert's company outsources work is called what?", year: null,
    eric: { options: ["Elbonia — its citizens are depicted knee-deep in mud at all times", "Molvania — a former Soviet state", "Genovia — a tiny European principality", "Freedonia — a Marx Brothers reference"], correct: 0, explanation: "Elbonia — a fictional Eastern European country whose citizens live permanently knee-deep in mud. Dilbert's company outsources to Elbonia as a parody of offshoring to low-cost countries. The Elbonians are eager but hilariously unqualified. The name avoids offending any real nation." },
    ruth: { options: ["Elbonia! Knee-deep in mud!", "Elbonia! Knee-deep in mud!", "A fictional outsourcing country", "Eric has never outsourced to Elbonia"], correct: 0, explanation: "Elbonia! Everyone stands knee-deep in mud. They're very keen workers though. Just... muddy." } },
  { id: 722, category: "dilbert", question: "How many newspapers carried Dilbert at its peak?", year: null,
    eric: { options: ["Over 2,000 newspapers in 65 countries and 25 languages", "About 500 newspapers in 20 countries", "About 1,000 newspapers in 40 countries", "About 100 newspapers — it was mainly online"], correct: 0, explanation: "Over 2,000 newspapers in 65 countries, translated into 25 languages. Adams won the National Cartoonists Society's Reuben Award (the profession's highest honour) in 1997. The strip ran from 16 April 1989 until syndication effectively ended in 2023." },
    ruth: { options: ["Over 2,000 newspapers!", "Over 2,000 newspapers!", "65 countries, 25 languages", "The biggest office comic in history"], correct: 0, explanation: "Two thousand newspapers in 65 countries! The most successful office comic strip ever created." } },
  { id: 723, category: "dilbert", question: "The Dilbert TV show aired on which network, and who voiced Dilbert?", year: 1999,
    eric: { options: ["UPN — Daniel Stern voiced Dilbert", "Fox — Hank Azaria voiced Dilbert", "Comedy Central — Jason Alexander voiced Dilbert", "NBC — Dan Castellaneta voiced Dilbert"], correct: 0, explanation: "UPN (United Paramount Network). Daniel Stern (the narrator from The Wonder Years / burglar from Home Alone) voiced Dilbert. Jason Alexander voiced Catbert. The company was named 'Path-E-Tech Management' (pathetic management). 30 episodes across 2 seasons (1999-2000)." },
    ruth: { options: ["UPN — Daniel Stern!", "UPN — Daniel Stern!", "The Home Alone burglar as Dilbert", "Only lasted 2 seasons"], correct: 0, explanation: "Daniel Stern — the Home Alone burglar — voiced Dilbert! The company was called 'Path-E-Tech Management.' Pathetic. Literally." } },
  { id: 724, category: "dilbert", question: "How does the Peter Principle differ from the Dilbert Principle?", year: null,
    eric: { options: ["Peter: competent people are promoted until they fail. Dilbert: incompetent people are promoted deliberately to get them out of the way", "Peter: people choose their own level. Dilbert: management chooses for them", "Peter: applies to military. Dilbert: applies to corporations only", "They are the same principle with different names"], correct: 0, explanation: "The Peter Principle (1969, Dr Laurence J. Peter): competent people get promoted until they reach a level where they're no longer competent. The Dilbert Principle (1996): companies promote ALREADY incompetent people to management deliberately, because that's where they do least damage. Under Peter, the person was once useful. Under Dilbert, they never were." },
    ruth: { options: ["Peter: once good, promoted too far. Dilbert: never good, promoted on purpose!", "Peter: once good, promoted too far. Dilbert: never good, promoted on purpose!", "Both are depressingly true", "Eric has witnessed both"], correct: 0, explanation: "Peter says you were once good. Dilbert says you were never good — they promoted you to get you out of the way!" } },
  { id: 725, category: "dilbert", question: "Carol, the Boss's secretary, is known for what personality trait?", year: null,
    eric: { options: ["Vindictive — she weaponises her gatekeeping power over calendars, paperwork, and office access", "Cheerful — she's the only happy person in the office", "Absent-minded — she constantly loses important documents", "Romantic — she has a crush on Dilbert"], correct: 0, explanation: "Vindictive! Carol weaponises bureaucracy — scheduling meetings at inconvenient times, 'losing' paperwork, and controlling access to the Boss's calendar with calculated cruelty. She is underpaid, undervalued, and fully aware of it. She has fantasised about harming the Boss." },
    ruth: { options: ["Vindictive!", "Vindictive!", "She weaponises the calendar", "Eric's secretary was nicer (hopefully)"], correct: 0, explanation: "Vindictive! She controls the calendar, loses your paperwork 'accidentally,' and fantasises about harming the Boss." } },
  { id: 726, category: "dilbert", question: "The strip debuted on 16 April 1989. When and why did syndication effectively end?", year: 2023,
    eric: { options: ["2023 — hundreds of newspapers dropped the strip after Scott Adams made racist comments on his YouTube show", "2020 — Adams retired voluntarily", "2015 — declining readership in the digital age", "It's still running in newspapers today"], correct: 0, explanation: "February 2023. Adams called Black Americans a 'hate group' on his YouTube show and advised white people to 'get away from Black people.' Newspapers (Washington Post, LA Times, USA Today, hundreds more), Andrews McMeel Syndication, and Penguin Random House all dropped him within days. After 34 years and 2,000+ newspapers." },
    ruth: { options: ["2023 — racist comments ended his career", "2023 — racist comments ended his career", "34 years in 2,000 papers — gone in days", "A sad end to a brilliant strip"], correct: 0, explanation: "2023. Racist comments on YouTube. 34 years and 2,000 newspapers — all gone within days. Self-destruction." } },
  { id: 727, category: "dilbert", question: "Adams won the National Cartoonists Society's highest honour in 1997. What is it called?", year: 1997,
    eric: { options: ["The Reuben Award (Outstanding Cartoonist of the Year)", "The Pulitzer Prize for Cartooning", "The Charles M. Schulz Award", "The Golden Inkwell"], correct: 0, explanation: "The Reuben Award — the National Cartoonists Society's highest honour, named after Rube Goldberg. Adams won for Outstanding Cartoonist of the Year in 1997, the same year he also won Best Newspaper Comic Strip. The Dilbert Principle had been a #1 bestseller the year before." },
    ruth: { options: ["The Reuben Award!", "The Reuben Award!", "The highest honour in cartooning", "Named after Rube Goldberg"], correct: 0, explanation: "The Reuben Award — cartooning's highest honour! Won in 1997 at the peak of Dilbert's cultural dominance." } },
  { id: 728, category: "dilbert", question: "Adams drew strips in the bathroom at work. Where did he get his MBA?", year: 1986,
    eric: { options: ["UC Berkeley's Haas School of Business (1986)", "Harvard Business School", "Stanford Graduate School of Business", "Wharton School, University of Pennsylvania"], correct: 0, explanation: "UC Berkeley's Haas School of Business — MBA in 1986. He'd previously worked as a bank teller at Crocker National Bank (1979-86) with just an economics degree from Hartwick College. The MBA helped him understand exactly how dysfunctional corporate management was — perfect fuel for Dilbert." },
    ruth: { options: ["UC Berkeley!", "UC Berkeley!", "An MBA that led to cartoon genius", "Eric has qualifications too"], correct: 0, explanation: "UC Berkeley! His MBA taught him exactly how corporate management works — and how to mock it perfectly." } },
  { id: 729, category: "dilbert", question: "Some companies tried to ban employees from posting Dilbert strips on cubicle walls. Why is this ironic?", year: null,
    eric: { options: ["Banning the strip perfectly illustrated the strip's themes — clueless management suppressing employee expression", "The strip was actually pro-management and they misunderstood it", "Adams had paid those companies to ban it as a publicity stunt", "The strips contained classified company information"], correct: 0, explanation: "Banning a comic strip about oppressive management IS oppressive management. The irony was not lost on observers. Paradoxically, some companies also used Dilbert in training materials and presentations — apparently missing that the strip was mocking them." },
    ruth: { options: ["Banning the strip IS the strip!", "Banning the strip IS the strip!", "Peak management irony", "Eric posted Dilbert on his cubicle wall"], correct: 0, explanation: "Banning a comic about bad management is EXACTLY what bad management would do! The strip writes itself." } },
  { id: 730, category: "dilbert", question: "The TV show gave Dilbert's company a name. What was it?", year: 1999,
    eric: { options: ["Path-E-Tech Management (a play on 'pathetic management')", "Dilbert Industries Inc.", "TechCorp Solutions", "Initrode Systems"], correct: 0, explanation: "Path-E-Tech Management — 'pathetic management.' In the strip itself, the company deliberately has no name — it represents every dysfunctional corporation. The TV show needed a name for practical reasons and chose the most on-brand option possible." },
    ruth: { options: ["Path-E-Tech Management — pathetic!", "Path-E-Tech Management — pathetic!", "The strip company has no name", "Eric's company had a real name"], correct: 0, explanation: "Pathetic Management! The TV show's writers couldn't resist the pun. In the strip, the company has no name — it's ALL companies." } },
  { id: 731, category: "dilbert", question: "Does Dilbert have a last name?", year: null,
    eric: { options: ["No — Adams deliberately kept it ambiguous", "Yes — it's Adams (the creator's name)", "Yes — it's Smith (revealed in a 2005 strip)", "Yes — it's Engineer (it's both his name and his job)"], correct: 0, explanation: "No confirmed last name. Adams deliberately kept it ambiguous. He's just 'Dilbert' — like Cher or Madonna but with less glamour and more cubicle. His eyes are also never visible — hidden behind featureless white glasses with no pupils." },
    ruth: { options: ["No! Just Dilbert!", "No! Just Dilbert!", "Like Cher but in a cubicle", "Eric has a last name (Davidson)"], correct: 0, explanation: "No last name! Just Dilbert. No visible eyes either — just two white circles for glasses. A man erased by corporate life." } },
  { id: 732, category: "dilbert", question: "What 'corporate sin' gets you darned to Heck by Phil, the Prince of Insufficient Light?", year: null,
    eric: { options: ["Stealing office supplies, padding expense reports, or using the company printer for personal documents", "Murder, arson, and grand theft", "Being too productive and making colleagues look bad", "Arriving early and leaving late (too keen)"], correct: 0, explanation: "Minor office sins! Stealing pens, padding expenses, personal printing, taking the last coffee without making a new pot. Phil handles sins too trivial for actual Hell. He darns you to Heck with his giant spoon. Satan handles the serious stuff." },
    ruth: { options: ["Stealing office supplies and using the work printer!", "Stealing office supplies and using the work printer!", "Not serious enough for Hell", "Eric has stolen a pen or two (who hasn't?)"], correct: 0, explanation: "Minor sins! Office supplies, the work printer, the last biscuit. Not bad enough for Hell — just Heck." } },
  { id: 733, category: "dilbert", question: "Dilbert was one of the first newspaper comics to do what revolutionary thing in 1993?", year: 1993,
    eric: { options: ["Include an email address in the strip, inviting reader feedback", "Publish online before print", "Accept storyline suggestions via fax", "Run a reader poll to decide the plot"], correct: 0, explanation: "Include an email address in the strip — revolutionary in 1993 when most people didn't have email. Adams was an early adopter of internet distribution. Dilbert.com became one of the first major comic websites. He received thousands of 'Are you spying on my company?' emails." },
    ruth: { options: ["Included an email address!", "Included an email address!", "Revolutionary in 1993", "Eric had email in 1993 (did he?)"], correct: 0, explanation: "An email address in a newspaper comic — in 1993! Before most people knew what email was." } },
  { id: 734, category: "dilbert", question: "Does the Pointy-Haired Boss have a name?", year: null,
    eric: { options: ["No — he represents EVERY bad manager, so Adams never named him", "Yes — Michael (revealed in the TV show only)", "Yes — Bob Boss (an obvious placeholder)", "Yes — Herbert, but it's only used once"], correct: 0, explanation: "No name. He represents every incompetent manager in every company everywhere. Giving him a name would limit him. He is simply 'The Boss' or 'PHB' (Pointy-Haired Boss). His devil-horn hair tells you everything you need to know." },
    ruth: { options: ["No name! He's EVERY bad manager!", "No name! He's EVERY bad manager!", "Just 'The Boss' or PHB", "Eric has known a few PHBs"], correct: 0, explanation: "No name — because he IS every bad manager. Every company has one. You probably work for one right now." } },
  { id: 735, category: "dilbert", question: "Dogbert frequently reinvents himself as what kind of professional to exploit companies?", year: null,
    eric: { options: ["A management consultant — charging enormous fees for obvious or terrible advice", "A lawyer — suing companies on behalf of their own employees", "A motivational speaker — selling empty inspiration", "A headhunter — placing incompetent people in senior roles"], correct: 0, explanation: "A management consultant! Dogbert charges enormous fees for advice that is either blindingly obvious or deliberately destructive — and companies love it. His ambition is to rule the world and enslave humanity, which he considers a natural extension of the consulting business model." },
    ruth: { options: ["A management consultant!", "A management consultant!", "Terrible advice for enormous fees", "Eric has hired a consultant or two"], correct: 0, explanation: "A management consultant! Terrible advice, enormous fees, and the companies keep coming back for more." } },
  { id: 736, category: "dilbert", question: "Ratbert occasionally works in which department — and what's the joke?", year: null,
    eric: { options: ["Marketing — because rats are well-suited to it", "Accounting — because rats are good with numbers", "Security — because rats are always watching", "Catering — because rats know their way around kitchens"], correct: 0, explanation: "Marketing — because rats are perfectly suited to it. Ratbert is desperate for love and acceptance, not very bright, and willing to do anything to fit in. Adams' view of marketing departments was not subtle." },
    ruth: { options: ["Marketing! Because rats are perfect for it!", "Marketing! Because rats are perfect for it!", "Adams was not kind to marketing", "Eric has opinions about marketing too"], correct: 0, explanation: "Marketing! Adams thought rats and marketing people had similar qualities. Not a compliment to either." } },

  // ─── Oman Electricity ─────────────────────────────────────────
  { id: 737, category: "oman-electricity", question: "Before Sultan Qaboos seized power in 1970, how many schools, hospitals, and kilometres of paved road did Oman have?", year: 1970,
    eric: { options: ["3 schools, 2 hospitals, and about 10 km of paved road for 1 million people", "50 schools, 20 hospitals, and 500 km of road", "No schools, no hospitals, and no roads at all", "100 schools, 10 hospitals, and 1,000 km of road"], correct: 0, explanation: "Just 3 primary schools (no secondary schools at all), 2 small hospitals, and about 10 km of paved road — all near Muscat — for a population of approximately 1 million. Sultan Said bin Taimur deliberately kept the country undeveloped. By 1980, Qaboos had built 363 schools, 28 hospitals, and 12,000 km of roads." },
    ruth: { options: ["3 schools, 2 hospitals, 10 km of road!", "3 schools, 2 hospitals, 10 km of road!", "For a million people!", "Eric is shocked (rightly so)"], correct: 0, explanation: "Three schools! Two hospitals! Ten kilometres of road! For a million people. Then Qaboos changed everything in a decade." } },
  { id: 738, category: "oman-electricity", question: "During the 1970 palace coup, the deposed Sultan Said bin Taimur suffered what injury, and where did he retire to?", year: 1970,
    eric: { options: ["He accidentally shot himself in the foot — then retired to a suite at the Dorchester Hotel, London", "He broke his arm falling down the palace stairs — retired to Cairo", "He was uninjured — retired to a villa in the south of France", "He was wounded by a palace guard — retired to a hospital in Bahrain"], correct: 0, explanation: "Shot himself in the foot during the confrontation (the coup was otherwise bloodless). Flown to London on an RAF transport aircraft, he lived in a suite at the Dorchester Hotel until his death in 1972. His son Qaboos was 29 and had been under virtual house arrest." },
    ruth: { options: ["Shot himself in the foot! Retired to the Dorchester!", "Shot himself in the foot! Retired to the Dorchester!", "You couldn't make this up", "Eric has stayed at the Dorchester (has he?)"], correct: 0, explanation: "Shot himself in the foot and retired to the Dorchester Hotel! The most comfortable exile in history." } },
  { id: 739, category: "oman-electricity", question: "Sultan Qaboos trained at Sandhurst and served with which Scottish regiment?", year: null,
    eric: { options: ["The Cameronians (Scottish Rifles) — in Germany", "The Black Watch — in Hong Kong", "The Royal Scots — in Cyprus", "The Gordon Highlanders — in Aden"], correct: 0, explanation: "The Cameronians (Scottish Rifles) in Germany. Qaboos was sent to England aged 16 in 1957, attended Sandhurst, then served as a Second Lieutenant. When he returned to Oman in 1964, his father kept him under house arrest until the 1970 coup." },
    ruth: { options: ["The Cameronians — a Scottish regiment!", "The Cameronians — a Scottish regiment!", "The Sultan served with Scottish soldiers", "Eric is impressed"], correct: 0, explanation: "A Scottish regiment! The Sultan of Oman served with the Cameronians. A very Scottish connection." } },
  { id: 740, category: "oman-electricity", question: "What plug type does Oman use, and why?", year: null,
    eric: { options: ["Type G (three rectangular pins) — identical to the UK, at 240V/50Hz. A direct British legacy", "Type C (European two-pin) at 220V/50Hz", "Type A (American two-pin flat) at 120V/60Hz", "Type I (Australian three-pin angled) at 230V/50Hz"], correct: 0, explanation: "Type G — the same three-rectangular-pin plug as the UK, at 240V/50Hz. A direct legacy of British involvement in Oman. The UK uses 230V/50Hz (harmonised in 1995 but still effectively 240V). You can plug your British appliances straight in." },
    ruth: { options: ["Same plug as the UK!", "Same plug as the UK!", "British legacy", "Eric can use his travel kettle (carefully)"], correct: 0, explanation: "Exactly the same plug as the UK! British influence means your UK appliances work in Oman." } },
  { id: 741, category: "oman-electricity", question: "In June 2018, the Omani town of Quriyat set a world record. For what?", year: 2018,
    eric: { options: ["Highest minimum (night-time) temperature ever recorded — 42.6°C. The temperature never dropped below 42.6°C for 24 hours", "Highest maximum temperature ever recorded — 62°C", "Longest continuous power cut — 72 hours", "Most air conditioners per capita"], correct: 0, explanation: "On 26 June 2018, Quriyat (population ~50,000) never dropped below 42.6°C (108.7°F) over a 24-hour period. The temperature stayed above 41.9°C for 51 straight hours. The peak was 49.8°C. Caused by high-pressure air trapping humid Indian Ocean air. The world's hottest night." },
    ruth: { options: ["The hottest NIGHT ever recorded — 42.6°C!", "The hottest NIGHT ever recorded — 42.6°C!", "It never cooled down", "Eric prefers Scottish temperatures"], correct: 0, explanation: "42.6°C was the MINIMUM! It never got cooler than that. The hottest night anywhere on Earth, ever recorded." } },
  { id: 742, category: "oman-electricity", question: "What percentage of Oman's peak summer electricity demand is caused by air conditioning?", year: null,
    eric: { options: ["Up to 70%", "About 30%", "About 50%", "About 90%"], correct: 0, explanation: "Up to 70% of peak demand is air conditioning. The average Omani household runs AC for 18 hours per day during peak summer. Oman's peak demand is in summer (driven by cooling), the exact opposite of the UK (winter, driven by heating)." },
    ruth: { options: ["70%!", "70%!", "Nearly three-quarters for air conditioning", "Eric would also need AC at 50°C"], correct: 0, explanation: "Seventy percent! Nearly all the electricity goes to keeping people cool. When it's 50°C outside, AC isn't optional." } },
  { id: 743, category: "oman-electricity", question: "Oman's electricity transmission system operates at which three voltage levels?", year: null,
    eric: { options: ["132kV, 220kV, and 400kV", "33kV, 66kV, and 132kV", "110kV, 275kV, and 400kV", "66kV, 132kV, and 275kV"], correct: 0, explanation: "132kV, 220kV, and 400kV — operated by OETC (Oman Electricity Transmission Company). Total: 4,369 km at 132kV, 1,960 km at 220kV, and 1,383 km at 400kV. The 400kV network is still being extended to connect north and south Oman." },
    ruth: { options: ["132kV, 220kV, and 400kV!", "132kV, 220kV, and 400kV!", "Eric knows these voltage levels well", "Same 132kV as Scotland"], correct: 0, explanation: "132kV, 220kV, and 400kV! Eric works with 132kV in Scotland — same voltage, very different climate." } },
  { id: 744, category: "oman-electricity", question: "The 'Rabt' project is connecting north and south Oman into a single national grid. How long are the 400kV lines?", year: 2023,
    eric: { options: ["Phase 1: 670 km (completed Nov 2023). Phase 2: 502 km (due 2026). Total cost: ~$966 million", "200 km total, cost $100 million", "1,500 km total, cost $5 billion", "50 km total, cost $20 million"], correct: 0, explanation: "Phase 1 completed November 2023: 670 km of 400kV from Nihada to Duqm with 5 grid stations. Phase 2 (due 2026): 502 km from Duqm south to Dhofar. Total: ~1,170 km, costing RO 372 million (~$966 million). Oman's grid is STILL being unified — the UK did this in the 1930s." },
    ruth: { options: ["670 km done, 502 km to go!", "670 km done, 502 km to go!", "Nearly a billion dollars", "The UK did this 90 years ago"], correct: 0, explanation: "Over 1,100 km of new 400kV lines! Costing nearly a billion dollars. Oman is unifying its grid — 90 years after the UK." } },
  { id: 745, category: "oman-electricity", question: "What fuel generates approximately 93% of Oman's electricity?", year: null,
    eric: { options: ["Natural gas", "Oil", "Solar", "Coal"], correct: 0, explanation: "Natural gas — overwhelmingly dominant at ~93%. Solar is growing fast (~4% and rising). Oman has no coal or nuclear. The country is investing massively in renewables with targets of 30% by 2030 and net zero by 2050, but natural gas remains king for now." },
    ruth: { options: ["Natural gas!", "Natural gas!", "93% from one fuel", "Eric's Scottish electricity is more varied"], correct: 0, explanation: "Natural gas — 93%! Almost all from one fuel. Very different from Scotland's mix of wind, gas, hydro, and nuclear." } },
  { id: 746, category: "oman-electricity", question: "The Dhofar Wind Farm (50 MW, 2019) holds what distinction?", year: 2019,
    eric: { options: ["First industrial-scale wind farm in the entire Middle East", "Largest wind farm in the world", "First offshore wind farm in the Arabian Sea", "First wind farm powered by the monsoon"], correct: 0, explanation: "The first industrial-scale wind farm in the Middle East. 13 GE turbines, each 3.8 MW, spread over 19 sq km near Shaleem. Developed by Masdar (Abu Dhabi) with Tanweer. $100 million investment. Average wind speeds 7-8 m/s from the khareef (monsoon)." },
    ruth: { options: ["First industrial wind farm in the Middle East!", "First industrial wind farm in the Middle East!", "Oman beat the whole region", "Eric approves of wind power"], correct: 0, explanation: "The first in the entire Middle East! 13 turbines in Dhofar. Oman — leading the Gulf in wind energy." } },
  { id: 747, category: "oman-electricity", question: "Oman has allocated 50,000 sq km for green hydrogen production. How big is that?", year: 2022,
    eric: { options: ["About the size of Slovakia", "About the size of Wales", "About the size of London", "About the size of France"], correct: 0, explanation: "About the size of Slovakia — 50,000 sq km in Al Wusta and Dhofar for HYDROM (Hydrogen Oman, formed 2022). Targets: 1 million tonnes/year by 2030, 8.5 million by 2050. The first auction in April 2023 awarded $20 billion of projects. The 2050 vision includes 300 million solar panels and 10,000 wind turbines." },
    ruth: { options: ["The size of Slovakia!", "The size of Slovakia!", "That's a LOT of desert for hydrogen", "Eric is impressed by the scale"], correct: 0, explanation: "An area the size of Slovakia! For making green hydrogen from solar and wind. $20 billion of projects in the first auction alone." } },
  { id: 748, category: "oman-electricity", question: "Sohar Aluminium has its own captive power plant. How big is it?", year: null,
    eric: { options: ["1,000 MW — dedicated entirely to the aluminium smelter", "100 MW", "250 MW", "50 MW"], correct: 0, explanation: "1,000 MW — one gigawatt — dedicated entirely to smelting aluminium. Jointly owned by OQ Group, Abu Dhabi's TAQA, and Rio Tinto. The $504 million power plant EPC contract was the largest element of the whole Sohar Aluminium project. Aluminium smelting is extraordinarily power-hungry." },
    ruth: { options: ["1,000 MW! Just for aluminium!", "1,000 MW! Just for aluminium!", "A whole power station for one factory", "Eric knows how much power smelters need"], correct: 0, explanation: "A GIGAWATT! Just to melt aluminium! One factory with its own power station the size of a large town's supply." } },
  { id: 749, category: "oman-electricity", question: "Oman's Musandam Governorate has an isolated electricity supply. Why can't it connect to the main grid?", year: null,
    eric: { options: ["Musandam is an exclave — separated from mainland Oman by UAE territory", "The terrain is too mountainous for transmission lines", "A treaty with Iran prohibits cross-border cables", "The submarine cable technology doesn't exist for that depth"], correct: 0, explanation: "Musandam is an Omani exclave, separated from the mainland by the UAE. It commands the strategic Strait of Hormuz. Power comes from local diesel generators managed by Tanweer. The government provides free electricity and water to remote fishing villages and Bedouin communities there." },
    ruth: { options: ["It's separated from Oman by the UAE!", "It's separated from Oman by the UAE!", "An exclave — like a geographical island", "Eric understands remote supply challenges"], correct: 0, explanation: "Musandam is cut off from mainland Oman by the UAE! It has its own little electricity system powered by diesel generators." } },
  { id: 750, category: "oman-electricity", question: "The Ibri II Solar PV plant (500 MW, 2021) uses what type of solar panels?", year: 2021,
    eric: { options: ["1.5 million bifacial panels (generating from both sides)", "Traditional monocrystalline single-sided panels", "Thin-film cadmium telluride panels", "Concentrated solar power mirrors"], correct: 0, explanation: "1.5 million bifacial panels — they generate electricity from both the front and rear surfaces (the rear captures reflected light from the ground). 500 MW, covering 13 million sq m. Led by ACWA Power. $417 million investment. Powers 50,000 homes. Oman's first solar IPP." },
    ruth: { options: ["Bifacial — generating from both sides!", "Bifacial — generating from both sides!", "1.5 million of them", "Eric thinks that's clever (it is)"], correct: 0, explanation: "Bifacial panels! They generate from front AND back. 1.5 million of them across 13 million square metres." } },
  { id: 751, category: "oman-electricity", question: "What is the British officer Timothy Landon's nickname, and what role did he play?", year: 1970,
    eric: { options: ["'The White Sultan' — he was instrumental in the 1970 coup and served as Qaboos's trusted adviser for a decade", "'The Desert Fox' — he commanded Omani forces in the Dhofar War", "'Lawrence of Oman' — he explored the Empty Quarter", "'The Iron Major' — he trained the Sultan's bodyguard"], correct: 0, explanation: "'The White Sultan' — Brigadier Timothy Landon was Qaboos's contemporary at Sandhurst and instrumental in the 1970 palace coup. He served as a trusted adviser throughout the 1970s. He insisted Qaboos was firmly in charge and found the nickname bemusing." },
    ruth: { options: ["'The White Sultan'!", "'The White Sultan'!", "A British officer behind the scenes", "Eric knows his Oman history"], correct: 0, explanation: "The White Sultan! A British officer who helped plan the coup and advised Qaboos for a decade." } },
  { id: 752, category: "oman-electricity", question: "Sultan Qaboos ruled Oman for almost exactly how many years?", year: 2020,
    eric: { options: ["50 years — from 23 July 1970 to 10 January 2020", "30 years", "40 years", "60 years"], correct: 0, explanation: "Almost exactly 50 years — from the coup on 23 July 1970 to his death on 10 January 2020. He transformed Oman from one of the most undeveloped countries on Earth to a modern state. His successor Sultan Haitham bin Tariq was named by Qaboos's will." },
    ruth: { options: ["50 years!", "50 years!", "Transformed the country completely", "From 3 schools to a modern nation"], correct: 0, explanation: "Fifty years! From medieval underdevelopment to a modern nation. One of the most dramatic transformations in history." } },
  { id: 753, category: "oman-electricity", question: "Oman's electricity sector was reformed in 2004. What was the key change?", year: 2004,
    eric: { options: ["Unbundled generation, transmission, distribution, and supply into separate companies with an independent regulator", "Nationalised all private generators", "Switched from oil to nuclear power", "Connected to the European grid via submarine cable"], correct: 0, explanation: "Royal Decree 78/2004 unbundled the vertically integrated monopoly into separate generation, transmission, distribution, and supply companies. An independent regulator (Authority for Electricity Regulation, now APSR) was established. The new market came into force in 2005." },
    ruth: { options: ["Split into separate companies!", "Split into separate companies!", "Like the UK did in the 1990s", "Eric lived through UK privatisation too"], correct: 0, explanation: "Split the monopoly into separate companies for generation, transmission, distribution, and supply. Sound familiar?" } },
  { id: 754, category: "oman-electricity", question: "What percentage of Oman's total workforce are expatriates?", year: null,
    eric: { options: ["Approximately 81%", "About 50%", "About 30%", "About 95%"], correct: 0, explanation: "About 81% of the total workforce. The population is roughly 57% Omani citizens and 43% expatriates. Major expat groups: Bangladeshi (~637,000), Indian (~507,000), Pakistani (~317,000). The power stations, refineries, and infrastructure are largely built and operated by expatriate workers." },
    ruth: { options: ["81%!", "81%!", "Four out of five workers are expats", "Eric could work in Oman"], correct: 0, explanation: "81%! Four out of five workers in Oman are from other countries. The infrastructure is built by a global workforce." } },
  { id: 755, category: "oman-electricity", question: "Oman is unique among GCC states for what grid connectivity reason?", year: null,
    eric: { options: ["It's the only GCC state not directly connected to the GCCIA grid — it connects indirectly via the UAE", "It's the only GCC state with a 60Hz system", "It's the only GCC state with nuclear power", "It's the only GCC state with no gas-fired generation"], correct: 0, explanation: "The only GCC state not directly connected to the GCCIA (GCC Interconnection Authority) grid. It connects indirectly via the UAE's network at 220kV with 400 MW capacity. A direct 400kV connection (~530 km, ~$700 million) is planned." },
    ruth: { options: ["Not directly connected to the Gulf grid!", "Not directly connected to the Gulf grid!", "The odd one out among Gulf states", "Eric understands grid interconnection"], correct: 0, explanation: "The only Gulf state not directly plugged into the regional grid! Has to go through the UAE instead." } },
  { id: 756, category: "oman-electricity", question: "Britain has three GCHQ spy bases in Oman. What are their codenames?", year: null,
    eric: { options: ["Timpani, Guitar, and Clarinet", "Alpha, Bravo, and Charlie", "Sandstorm, Mirage, and Oasis", "Falcon, Eagle, and Hawk"], correct: 0, explanation: "Timpani, Guitar, and Clarinet — all musical instrument codenames. The British intelligence presence in Oman is part of the deep and long-standing UK-Oman security relationship. British officers commanded Oman's armed forces throughout the 1970s and 1980s." },
    ruth: { options: ["Timpani, Guitar, and Clarinet!", "Timpani, Guitar, and Clarinet!", "Musical codenames for spy bases", "Eric probably shouldn't know this"], correct: 0, explanation: "Musical codenames! Timpani, Guitar, and Clarinet. British spy bases in Oman. Very James Bond." } },
  { id: 757, category: "oman-electricity", question: "Oman's MIS peak demand in 2024 was 7,503 MW. What is it forecast to reach by 2031?", year: null,
    eric: { options: ["12,198 MW — growth of 7.2% per year", "8,500 MW — modest growth", "20,000 MW — explosive growth", "7,500 MW — flat demand"], correct: 0, explanation: "12,198 MW — growth rate of 7.2% per year. The Dhofar system is growing even faster at 9.1%. This growth is driven by population increase, economic development, and the insatiable demand for air conditioning in a country where it can reach 50°C." },
    ruth: { options: ["12,198 MW — 7.2% growth per year!", "12,198 MW — 7.2% growth per year!", "Demand nearly doubling in 7 years", "More AC needed every year"], correct: 0, explanation: "Nearly doubling in 7 years! 7.2% growth annually. All that air conditioning in a country approaching 50 degrees." } },
  { id: 758, category: "oman-electricity", question: "The Manah I and II solar plants (combined 1 GW, 2025) had what dramatic effect on Oman's renewable capacity?", year: 2025,
    eric: { options: ["More than doubled it — renewable share jumped from 6.6% to 11%", "Increased it by 10%", "Tripled it to 30%", "Had minimal impact — still under 5%"], correct: 0, explanation: "More than doubled Oman's installed renewable capacity, raising the share from 6.6% to 11%. Manah I (500 MW, EDF Renewables) and Manah II (588 MW, Sembcorp) together use over 1.5 million bifacial panels. Each powers 60,000 homes." },
    ruth: { options: ["More than DOUBLED renewable capacity!", "More than DOUBLED renewable capacity!", "From 6.6% to 11% in one step", "Eric approves of solar power"], correct: 0, explanation: "Doubled in one step! Two massive solar farms brought Oman from 6.6% to 11% renewable. A big leap." } },
  { id: 759, category: "oman-electricity", question: "Oman's electricity is heavily subsidised. What does a residential customer pay for the first 4,000 kWh?", year: null,
    eric: { options: ["14 baisas/kWh (about 3.6 US cents — roughly a quarter of UK prices)", "50 baisas/kWh (about 13 US cents)", "100 baisas/kWh (about 26 US cents)", "Free for all citizens"], correct: 0, explanation: "14 baisas/kWh — about 3.6 US cents, roughly a quarter of UK prices. (1 Omani Rial = 1,000 baisas ≈ $2.60). Above 6,000 kWh, the rate jumps to 32 baisas. The subsidy system has been described as 'unsustainable.' Agricultural/fishing customers pay even less (12 baisas)." },
    ruth: { options: ["About 3.6 US cents — a quarter of UK prices!", "About 3.6 US cents — a quarter of UK prices!", "Very cheap electricity", "Eric pays a LOT more in Scotland"], correct: 0, explanation: "About a quarter of what Eric pays! Heavily subsidised — the government picks up the rest." } },
  { id: 760, category: "oman-electricity", question: "Oman's peak electricity demand is in summer (cooling). The UK's is in winter (heating). What else is opposite?", year: null,
    eric: { options: ["Oman started electrifying in 1970; the UK started in the 1880s — a 90-year gap. Oman's grid is still being unified; the UK's was unified in the 1930s", "Oman uses DC; the UK uses AC", "Oman's frequency is 60Hz; the UK's is 50Hz", "There are no other differences"], correct: 0, explanation: "Almost everything is opposite: summer peak vs winter peak, 1970 start vs 1880s start, grid still unifying vs unified since 1933, 93% gas vs diverse mix, 70% of demand for cooling vs heating dominant. But they share the same plug (Type G), same frequency (50Hz), and similar transmission voltages (132kV, 400kV)." },
    ruth: { options: ["90 years behind on electrification!", "90 years behind on electrification!", "But same plug and frequency", "Eric has worked in both worlds"], correct: 0, explanation: "Oman started 90 years after the UK! Summer vs winter peaks, one fuel vs many. But the same plugs and voltage." } },
  { id: 761, category: "oman-electricity", question: "Oman's HYDROM first auction (April 2023) awarded how much in green hydrogen projects?", year: 2023,
    eric: { options: ["$20 billion — 6 projects with 15 GW of electrolyser capacity", "$1 billion", "$5 billion", "$50 billion"], correct: 0, explanation: "$20 billion in the first auction alone! 6 projects with 15 GW of electrolyser capacity. The 2050 vision includes 300 million solar panels, 10,000 wind turbines, 5,200 electrolysers, and up to 180 GW of renewable capacity. Oman is betting big on green hydrogen." },
    ruth: { options: ["$20 BILLION!", "$20 BILLION!", "In the very first auction", "Eric is impressed by the ambition"], correct: 0, explanation: "Twenty billion dollars! In the first auction! With visions of 300 million solar panels by 2050. Oman is going big." } },
  { id: 762, category: "oman-electricity", question: "Sohar Industrial Port is a joint venture with which European port?", year: null,
    eric: { options: ["Port of Rotterdam (Netherlands)", "Port of Hamburg (Germany)", "Port of Antwerp (Belgium)", "Port of Felixstowe (UK)"], correct: 0, explanation: "Port of Rotterdam — the largest port in Europe. The Sohar Industrial Port Complex is a joint venture between the Government of Oman and the Port of Rotterdam. Sohar Industrial City has 354 factories and $27 billion in investment since 2010." },
    ruth: { options: ["Rotterdam!", "Rotterdam!", "Europe's biggest port helped build Sohar", "Eric knows his ports"], correct: 0, explanation: "Rotterdam! Europe's biggest port partnered with Oman to build Sohar. Dutch-Omani cooperation." } },
  { id: 763, category: "oman-electricity", question: "Oil was first discovered in Oman near which location, and when did production begin?", year: 1967,
    eric: { options: ["Discovered near Fahud in 1964; production began August 1967", "Discovered in Muscat in 1950; production began 1955", "Discovered in Dhofar in 1970; production began 1972", "Discovered offshore in 1958; production began 1960"], correct: 0, explanation: "Discovered near Fahud in 1964; production began August 1967. Oil generates 68-85% of government revenue. Oman produces about 775,000 barrels per day (2025). Not a member of OPEC but participates in OPEC+ production agreements." },
    ruth: { options: ["Fahud 1964, production from 1967!", "Fahud 1964, production from 1967!", "Oil changed Oman forever", "Three years before Qaboos took over"], correct: 0, explanation: "Fahud, 1964! Production started just three years before Qaboos seized power and transformed the country." } },
  { id: 764, category: "oman-electricity", question: "Oman's Nama Group holds 99.99% of shares in how many subsidiary companies?", year: null,
    eric: { options: ["Eight subsidiaries (covering transmission, distribution, procurement, supply, and rural areas)", "Three subsidiaries", "Twelve subsidiaries", "One subsidiary"], correct: 0, explanation: "Eight subsidiary companies — covering the full electricity value chain: OETC (transmission), Nama Power and Water Procurement, Nama Electricity Distribution, Nama Supply, Nama Dhofar Services, Tanweer (rural), and others. Plus 98.10% of Dhofar Power Company. Owned by the Oman Investment Authority." },
    ruth: { options: ["Eight!", "Eight!", "One group, eight companies", "Eric understands corporate structures"], correct: 0, explanation: "Eight subsidiaries! One holding company controlling the whole electricity sector." } },
  { id: 765, category: "oman-electricity", question: "What does 'Tanweer' mean, and what does the company do?", year: null,
    eric: { options: ["'Illumination' in Arabic — it electrifies remote and rural areas of Oman, mostly with diesel generators transitioning to solar-diesel hybrids", "'Power' in Arabic — it generates electricity for Muscat", "'Connection' in Arabic — it operates the transmission grid", "'Water' in Arabic — it manages desalination plants"], correct: 0, explanation: "'Tanweer' means illumination/enlightenment in Arabic. Formerly RAECO (Rural Areas Electricity Company), it electrifies remote areas including the Musandam exclave using diesel generators — now transitioning to 200 MW of solar-diesel hybrid projects at 11 locations." },
    ruth: { options: ["'Illumination' — electrifying remote Oman!", "'Illumination' — electrifying remote Oman!", "A beautiful name for an electricity company", "Eric appreciates good branding"], correct: 0, explanation: "Illumination! A beautiful name for the company that brings electricity to Oman's most remote villages." } },
  { id: 766, category: "oman-electricity", question: "Oman's renewable energy target for 2030 is what percentage?", year: null,
    eric: { options: ["30% (currently ~11% after Manah I and II)", "10%", "50%", "5%"], correct: 0, explanation: "30% by 2030, up from ~11% after the Manah solar plants opened in 2025. Further targets: 39% by 2040, net zero by 2050. This is ambitious given 93% of generation is currently natural gas. The green hydrogen programme is key to the long-term plan." },
    ruth: { options: ["30% by 2030!", "30% by 2030!", "Up from 11% now", "A big ambition for a gas-powered country"], correct: 0, explanation: "30% renewable by 2030! From 93% gas to 30% renewable in just 5 years. Ambitious doesn't cover it." } },

  // ─── Lightswitches ────────────────────────────────────────────
  { id: 767, category: "lightswitches", question: "Who invented the quick-break light switch in 1884, and where was he from?", year: 1884,
    eric: { options: ["John Henry Holmes — a Quaker electrical engineer from Newcastle upon Tyne", "Thomas Edison — from Menlo Park, New Jersey", "Nikola Tesla — from Smiljan, Croatia", "Sebastian de Ferranti — from Liverpool"], correct: 0, explanation: "John Henry Holmes — British Patent No. 3256, filed 14 February 1884. A Quaker, educated at the Friends School at Bootham in York, then Durham College of Science. He and his brother Theodore founded J.H. Holmes & Co. in Shieldfield, Newcastle. The quick-break mechanism remains the basis of all modern wall switches." },
    ruth: { options: ["A Quaker from Newcastle!", "A Quaker from Newcastle!", "Invented in 1884", "Eric flicks his switch many times a day"], correct: 0, explanation: "A Quaker from Newcastle! John Henry Holmes. Every light switch in the world uses his invention." } },
  { id: 768, category: "lightswitches", question: "Why were mercury light switches marketed as 'silent' switches?", year: null,
    eric: { options: ["Mercury flows silently over the contacts — no spring-loaded snap mechanism needed", "They were wrapped in soundproofing material", "They operated at a frequency too high for human hearing", "The mercury absorbed the sound waves from the click"], correct: 0, explanation: "Mercury (the only metal liquid at room temperature, melting point -38.83°C) flows silently over the contacts when the sealed glass envelope tilts. No spring, no snap, no click. Popular from the 1950s. Manufacturing banned in the US since 1991 (mercury is toxic)." },
    ruth: { options: ["Mercury flows silently — no click!", "Mercury flows silently — no click!", "Liquid metal as a switch", "Eric prefers the click (it's satisfying)"], correct: 0, explanation: "Liquid mercury glides silently over the contacts. No mechanical snap. Lovely and quiet — but poisonous." } },
  { id: 769, category: "lightswitches", question: "Before inventing the dimmer switch, Joel Spira worked on what at an aerospace company?", year: 1959,
    eric: { options: ["Triggers for atomic weapons — using thyristors (the same technology he used for the dimmer)", "Jet engine control systems", "Satellite communications", "Radar displays"], correct: 0, explanation: "Triggers for atomic weapons! Spira recognised that the thyristor (a solid-state semiconductor switch used in bomb triggers) could also vary the intensity of AC-powered lights. In 1959, tinkering in his Manhattan apartment, he created the first solid-state residential dimmer. He founded Lutron Electronics in 1961." },
    ruth: { options: ["Atomic bomb triggers!", "Atomic bomb triggers!", "From nuclear weapons to dimmer switches", "Eric uses dimmers (less explosive)"], correct: 0, explanation: "Atomic bomb triggers! Same technology, very different application. From destroying cities to dimming your living room lamp." } },
  { id: 770, category: "lightswitches", question: "X10, the first general-purpose home automation technology (1975), was developed where?", year: 1975,
    eric: { options: ["Glenrothes, Scotland — by Pico Electronics", "Silicon Valley, California", "Tokyo, Japan", "Cambridge, England"], correct: 0, explanation: "Glenrothes, Scotland! Pico Electronics developed X10 in 1975. It sent control signals over existing AC wiring — no new cables needed. Products appeared in RadioShack from 1978. The idea came from the ADC Accutrac 4000, a programmable LP turntable they'd developed in 1974." },
    ruth: { options: ["Glenrothes, SCOTLAND!", "Glenrothes, SCOTLAND!", "Smart homes were invented in Fife", "Eric is proud of Scottish innovation"], correct: 0, explanation: "Smart home technology was invented in Fife! Glenrothes, Scotland. Inspired by a record player." } },
  { id: 771, category: "lightswitches", question: "What makes a light switch 'click'?", year: null,
    eric: { options: ["A spring-loaded over-center mechanism — the spring stores energy then releases it suddenly at the tipping point, snapping the contacts across", "A small hammer strikes a bell inside the switch", "The metal contacts vibrate when they touch", "Air pressure escaping from a sealed chamber"], correct: 0, explanation: "The over-center (snap-action) mechanism. A spring blade stores energy as you move the toggle, then reaches a critical tipping point and snaps across, driving the contacts rapidly to the new position. This also prevents arcing — the contacts move so fast no arc can form. Holmes's 1884 quick-break principle in action." },
    ruth: { options: ["A spring snapping past its tipping point!", "A spring snapping past its tipping point!", "The most satisfying sound in a house", "Eric appreciates a good click"], correct: 0, explanation: "A spring snaps past its tipping point! That satisfying click means the contacts moved too fast for an arc to form." } },
  { id: 772, category: "lightswitches", question: "In the UK, do you flip a light switch UP or DOWN to turn it on?", year: null,
    eric: { options: ["DOWN for on (the opposite of the US, where UP = on)", "UP for on (same as the US)", "Sideways (UK uses rocker switches exclusively)", "It varies by region"], correct: 0, explanation: "DOWN for on in the UK (and most Commonwealth countries). UP for on in the US and Canada. No international standard has ever been agreed. There's no definitive historical reason — the conventions simply diverged in the early 20th century and were never reconciled." },
    ruth: { options: ["DOWN! (US is the opposite!)", "DOWN! (US is the opposite!)", "Two countries divided by a switch", "Eric knows which way is on"], correct: 0, explanation: "Down for on! Americans do it the other way. Nobody can agree and nobody can explain why." } },
  { id: 773, category: "lightswitches", question: "Why must bathroom light switches in the UK be pull-cord or outside the room?", year: null,
    eric: { options: ["BS 7671 wiring regulations define bathroom zones — standard switches are prohibited near baths/showers due to electrocution risk at 230V", "It's a building regulation about aesthetics", "To prevent children playing with switches while in the bath", "It's actually not a legal requirement — just a convention"], correct: 0, explanation: "BS 7671 (IET Wiring Regulations) defines zones around baths and showers. Standard switches cannot be installed within these zones because a wet person touching a 230V switch risks electrocution. Pull-cord switches are permitted because the non-conductive cord provides safe separation. This is largely a UK/Irish requirement." },
    ruth: { options: ["Water + 230V = danger!", "Water + 230V = danger!", "The pull-cord keeps you safe", "Eric always uses the pull-cord"], correct: 0, explanation: "Water and 230 volts don't mix! The pull-cord keeps your wet hands away from the electricity." } },
  { id: 774, category: "lightswitches", question: "What is a 'dolly switch'?", year: null,
    eric: { options: ["The British term for a toggle light switch — the small lever is called the 'dolly'", "A switch activated by a porcelain figurine", "A miniature switch used in dolls' houses", "A switch that controls a rotating ceiling light"], correct: 0, explanation: "The British term for a toggle light switch. The small lever that flips up and down is called the 'dolly.' Also called a tumbler switch (the lever tumbles between positions) or snap switch (from the click). All the same device — different names." },
    ruth: { options: ["British term for a toggle switch!", "British term for a toggle switch!", "The little lever is called the 'dolly'", "Eric has flipped many a dolly"], correct: 0, explanation: "The 'dolly' is the little lever! A very British term for a very everyday object." } },
  { id: 775, category: "lightswitches", question: "The Clapper ('Clap On! Clap Off!') was originally called what, and where was it invented?", year: 1985,
    eric: { options: ["'The Great American Turn-On' — despite being invented in Canada", "'The Sound Switch' — invented in Japan", "'The Thunder Box' — invented in Texas", "'The Applause' — invented in Germany"], correct: 0, explanation: "'The Great American Turn-On' — invented in Canada by Peter Liljequist and Kou Chen (1985 Canadian patent). It didn't work properly — it short-circuited TVs. Joseph Pedott (the Chia Pet marketing genius) bought the patent, hired engineers to fix it, and renamed it 'The Clapper.' The iconic TV commercial ran for years." },
    ruth: { options: ["'The Great American Turn-On' — invented in CANADA!", "'The Great American Turn-On' — invented in CANADA!", "It didn't work at first", "Eric has never owned a Clapper (has he?)"], correct: 0, explanation: "The Great American Turn-On — invented in Canada! It didn't even work. Then a marketing genius fixed it and renamed it." } },
  { id: 776, category: "lightswitches", question: "Leo Baekeland invented Bakelite (used for light switch housings) in 1907. What was it intended to replace?", year: 1907,
    eric: { options: ["Shellac — made from lac insect secretions (limited supply)", "Porcelain — too fragile for mass production", "Wood — too flammable near electrical contacts", "Rubber — too flexible for rigid housings"], correct: 0, explanation: "Shellac! Made from the secretions of the lac insect — supply was limited and expensive. Baekeland (a Belgian chemist in Yonkers, New York) controlled pressure and temperature on phenol and formaldehyde to create Bakelite — 'The Material of a Thousand Uses.' It was an excellent electrical insulator." },
    ruth: { options: ["Shellac — made from insect secretions!", "Shellac — made from insect secretions!", "Bug juice replaced by plastic", "Eric's switches are probably plastic now"], correct: 0, explanation: "Insect secretions! Shellac came from bugs. Bakelite was the synthetic replacement. The classic round brown switch." } },
  { id: 777, category: "lightswitches", question: "Why do UK 13A sockets have switches when most other countries' sockets don't?", year: null,
    eric: { options: ["To prevent arcing when unplugging under load at 240V — the switch breaks the circuit before you pull the plug", "Because UK plugs are too heavy to remove safely without switching off first", "It's a wartime regulation that was never repealed", "Because UK sockets are recessed and the switch is needed to release the plug"], correct: 0, explanation: "Pulling a plug from a 240V socket under load creates a visible arc (spark) as the pin leaves the contact. The switch eliminates this by breaking the circuit first. At 240V the arc is more dangerous than at 120V (US). Switches weren't part of BS 1363 until 1967 but are now universal on UK sockets." },
    ruth: { options: ["To prevent sparks when unplugging!", "To prevent sparks when unplugging!", "240V makes bigger sparks than 120V", "Eric always switches off before unplugging"], correct: 0, explanation: "To stop sparks! At 240V, pulling a plug under load creates a visible arc. The switch prevents that." } },
  { id: 778, category: "lightswitches", question: "What does '2-gang 2-way' mean for a light switch?", year: null,
    eric: { options: ["Two independent switches on one faceplate, each controllable from two locations (e.g., top and bottom of stairs)", "A switch with two speeds", "A switch that controls two lights simultaneously", "Two switches wired in series for extra safety"], correct: 0, explanation: "'Gang' = number of switches on the plate (2-gang = two switches). 'Way' = number of locations that can control each circuit (2-way = two locations, using SPDT switches connected by 'traveller' wires). A 2-gang 2-way has two independent switches on one plate, each controllable from two places." },
    ruth: { options: ["Two switches, each controlled from two places!", "Two switches, each controlled from two places!", "Gangs and ways — very confusing", "Eric knows his gangs from his ways"], correct: 0, explanation: "Gangs = how many switches on the plate. Ways = how many locations can control the light. 2-gang 2-way = two switches, each with two controls." } },
  { id: 779, category: "lightswitches", question: "The knife switch — the bare-blade type used in early electricity — is famous in what cultural context?", year: null,
    eric: { options: ["The quintessential 'mad scientist' / Frankenstein switch — dramatic appearance and visible arcing when thrown", "The switch used to detonate dynamite in Western films", "The switch on early electric chairs", "The switch that powered the first Christmas tree lights"], correct: 0, explanation: "The Frankenstein switch! Its dramatic appearance and the visible arcing when thrown (exceeding 10,000°F / 5,500°C) cemented it as the quintessential mad scientist prop. Completely exposed conductors made it genuinely dangerous. Used from Edison's earliest installations (1881) through the early 1900s." },
    ruth: { options: ["The Frankenstein switch!", "The Frankenstein switch!", "The mad scientist's favourite prop", "Eric has never used a knife switch (probably)"], correct: 0, explanation: "The Frankenstein switch! Dramatic, dangerous, and arcing at 10,000°F. Every mad scientist needs one." } },
  { id: 780, category: "lightswitches", question: "What were light switches made of before Bakelite?", year: null,
    eric: { options: ["Porcelain (ceramic) — an excellent electrical insulator, common from the 1890s to the 1920s", "Cast iron", "Glass", "Hardwood with lacquer coating"], correct: 0, explanation: "Porcelain — the same material as fine china. Heavy and fragile, but an excellent electrical insulator. Porcelain rotary switches were common from the 1890s to the 1920s. Bakelite replaced them from the 1920s onward — lighter, mouldable, and mass-producible. The round brown Bakelite switch became ubiquitous." },
    ruth: { options: ["Porcelain! Like fine china!", "Porcelain! Like fine china!", "Heavy, fragile, but very safe", "Eric has seen porcelain switches in old houses"], correct: 0, explanation: "Porcelain! The same material as teacups. Heavy and breakable, but a brilliant insulator." } },
  { id: 781, category: "lightswitches", question: "Joel Spira founded Lutron Electronics to sell his dimmer switch. When, and with whom?", year: 1961,
    eric: { options: ["1961 in Coopersburg, Pennsylvania — co-founded with his wife Ruth Rodale Spira", "1970 in San Francisco — with his college roommate", "1955 in Manhattan — alone", "1975 in Tokyo — with Sony executives"], correct: 0, explanation: "1961 in Coopersburg, Pennsylvania, co-founded with his wife Ruth Rodale Spira. The first product was the 'Capri' dimmer. Spira headed Lutron for 54 years until his death in 2015. In 2010, the original dimmer was added to the Smithsonian's collection. He'd gone from atomic bomb triggers to mood lighting." },
    ruth: { options: ["1961 with his wife Ruth!", "1961 with his wife Ruth!", "From Manhattan apartment to Smithsonian", "Eric has Lutron dimmers (does he?)"], correct: 0, explanation: "1961! With his wife Ruth. Their first dimmer is now in the Smithsonian. From nuclear weapons to cosy lighting." } },
  { id: 782, category: "lightswitches", question: "The first touch-sensitive lamp appeared commercially in 1955. How did it work?", year: 1955,
    eric: { options: ["Body capacitance — touching the metal surface changes the circuit's capacitance, triggering a relay (originally using vacuum tubes, costing $35)", "A pressure sensor in the lamp base", "Static electricity from the human body", "Body heat detected by a thermocouple"], correct: 0, explanation: "Capacitive sensing — the human body has significant capacitance. Touching the metal surface increases the total capacitance, changing an oscillator's frequency, which triggers the switch. The 1955 Aladdin Industries lamp used vacuum tubes and cost $35. Mass-market versions didn't appear until the mid-1980s when ICs replaced the tubes." },
    ruth: { options: ["Your body changes the electrical capacitance!", "Your body changes the electrical capacitance!", "Touch the lamp, it knows you're there", "Eric has a touch lamp (magical)"], correct: 0, explanation: "Your body changes the capacitance! The lamp detects your touch through electrical physics. Like magic, but it's science." } },
  { id: 783, category: "lightswitches", question: "What inspired Pico Electronics in Glenrothes to develop X10 home automation in 1975?", year: 1975,
    eric: { options: ["The ADC Accutrac 4000 — a programmable LP turntable with ultrasound remote control they'd developed in 1974", "A NASA research contract for space station lighting control", "A request from the Royal Family for automated lighting at Balmoral", "A competition run by the BBC's Tomorrow's World"], correct: 0, explanation: "A programmable LP turntable! The Accutrac 4000 used ultrasound remote control. The Pico engineers thought: if we can remotely control a record player, why not lights and appliances? X10 sent control signals over existing AC wiring. Products appeared in RadioShack from 1978. Smart homes were born — in Fife." },
    ruth: { options: ["A record player!", "A record player!", "From turntable to smart home", "Smart homes started with vinyl"], correct: 0, explanation: "A record player! Scottish engineers went from remotely controlling a turntable to remotely controlling your entire house." } },
  { id: 784, category: "lightswitches", question: "Granville T. Woods patented a 'Safety Dimmer' for theatrical lighting in 1896. What was notable about Woods?", year: 1896,
    eric: { options: ["He was an African American inventor with over 60 patents who successfully defended a patent dispute against Thomas Edison", "He was blind and invented the dimmer by feel", "He was Thomas Edison's former business partner", "He was the first person to dim electric lights on Broadway"], correct: 0, explanation: "Granville T. Woods — an African American inventor with over 60 patents. He successfully defended patent disputes against Edison himself. His 1896 Safety Dimmer predated Spira's solid-state version by 63 years. Woods is sometimes called 'the Black Edison.' His dimmer used non-solid-state technology (rheostat-based)." },
    ruth: { options: ["An African American inventor who beat Edison in court!", "An African American inventor who beat Edison in court!", "Over 60 patents", "Eric respects a good inventor"], correct: 0, explanation: "Over 60 patents and he beat Edison in a patent dispute! Granville Woods — 'the Black Edison.' A remarkable inventor." } },
  { id: 785, category: "lightswitches", question: "The Leviton 'Decora' rocker switch became so dominant that 'Decora' became what?", year: 1973,
    eric: { options: ["A generic term for rocker switches — like Kleenex for tissues or Hoover for vacuum cleaners", "A registered trademark that competitors were sued for using", "The official BS standard term for rocker switches", "An adjective meaning 'modern-looking'"], correct: 0, explanation: "A generic term! Just as Kleenex = tissues and Hoover = vacuum cleaner, 'Decora' became the generic American term for any rocker-style light switch. The original Decora was patented in 1973 (US Patent 3,770,920, John Poliak, assigned to Leviton). Easier to operate than toggles — you can push it with an elbow." },
    ruth: { options: ["A generic word — like Hoover for vacuum!", "A generic word — like Hoover for vacuum!", "The brand became the thing", "Eric calls them rocker switches (British)"], correct: 0, explanation: "Like Hoover for vacuum cleaner! 'Decora' became the word for any rocker switch. The brand ate the category." } },
  { id: 786, category: "lightswitches", question: "What is the only metal that is liquid at room temperature, making it ideal for early silent light switches?", year: null,
    eric: { options: ["Mercury (melting point -38.83°C)", "Gallium (melting point 29.76°C)", "Caesium (melting point 28.44°C)", "Sodium (melting point 97.79°C)"], correct: 0, explanation: "Mercury — melting point -38.83°C, liquid at all normal temperatures. Excellent electrical conductor. In mercury switches, the liquid metal flows silently over contacts inside a sealed glass envelope. No spark, no click, no oxidation. But mercury is toxic — manufacturing was banned in the US from 1991." },
    ruth: { options: ["Mercury!", "Mercury!", "The only liquid metal at room temperature", "Eric knows his periodic table"], correct: 0, explanation: "Mercury! Liquid at room temperature, conducts electricity, and flows silently. Perfect for switches — except it's poisonous." } },

  // ─── Inventions in Eric's Lifetime ────────────────────────────
  { id: 787, category: "inventions", question: "The transistor was invented at Bell Labs in 1947. What did John Pierce name it — and why?", year: 1947,
    eric: { options: ["'Transistor' — a portmanteau of 'transfer' and 'resistor'", "'Amplitron' — because it amplified signals", "'Semicon' — short for semiconductor", "'Switchlet' — because it was a tiny switch"], correct: 0, explanation: "Bell Labs engineer John Pierce combined 'transfer' and 'resistor.' Bardeen and Brattain built the first (point-contact) transistor on 16 December 1947. They shared the 1956 Nobel with Shockley. Bardeen is one of only 4 people to win two Nobels." },
    ruth: { options: ["Transfer + resistor = transistor!", "Transfer + resistor = transistor!", "The invention that changed everything", "Eric was 3 years old"], correct: 0, explanation: "Transfer + resistor! The tiny device that replaced vacuum tubes and made the modern world possible." } },
  { id: 788, category: "inventions", question: "Percy Spencer discovered microwave cooking in 1945 when what happened?", year: 1945,
    eric: { options: ["A chocolate bar in his pocket melted while he stood near an active magnetron (radar component)", "His lunch exploded in a laboratory oven", "He accidentally cooked an egg with a radio antenna", "Lightning struck a metal bowl containing popcorn"], correct: 0, explanation: "Standing near a magnetron, the chocolate bar in his pocket melted. He then tried popcorn (it popped) and an egg (it exploded). The first commercial 'Radarange' (1947) was 5ft 6in tall, weighed 750 lbs, and cost $3,000. Spencer had no formal education beyond grammar school." },
    ruth: { options: ["His chocolate bar melted near radar equipment!", "His chocolate bar melted near radar equipment!", "Then the egg exploded", "Eric uses a microwave daily"], correct: 0, explanation: "Chocolate melted in his pocket! Then he tried an egg — which exploded. From radar to ready meals." } },
  { id: 789, category: "inventions", question: "The Manchester Baby (21 June 1948) was the world's first what?", year: 1948,
    eric: { options: ["Electronic stored-program computer — instructions held in memory alongside data", "Electronic calculator", "Computer with a screen display", "Computer connected to a telephone network"], correct: 0, explanation: "First electronic stored-program computer — the architecture ALL modern computers use. Built by Williams, Kilburn, and Tootill at Manchester University. Colossus (1944) was electronic but special-purpose. ENIAC (1946) was general-purpose but needed physical rewiring to change programs. The Baby stored its program in electronic memory." },
    ruth: { options: ["First stored-program computer!", "First stored-program computer!", "The architecture every computer still uses", "Eric was 4 when this happened"], correct: 0, explanation: "The first computer that stored its program in memory! Every computer since — including the one running this quiz — works the same way." } },
  { id: 790, category: "inventions", question: "Jack Kilby invented the integrated circuit at Texas Instruments in 1958. Why was he alone in the lab?", year: 1958,
    eric: { options: ["He was a new employee with no holiday entitlement — everyone else was on vacation", "He'd been fired but snuck back in", "A snowstorm trapped him in the building", "He was working a night shift nobody else wanted"], correct: 0, explanation: "A new employee with no vacation! While everyone else was on summer holiday, Kilby worked alone and built the first IC. He won the 2000 Nobel Prize. Robert Noyce (Fairchild) independently invented the monolithic version in 1959 but died in 1990 — Nobels aren't awarded posthumously." },
    ruth: { options: ["Everyone else was on holiday!", "Everyone else was on holiday!", "He had no vacation days", "Eric appreciates dedication"], correct: 0, explanation: "The new boy with no holidays invented the microchip while everyone else was at the beach!" } },
  { id: 791, category: "inventions", question: "The first message sent over ARPANET (the internet's precursor) on 29 October 1969 was accidentally what?", year: 1969,
    eric: { options: ["'Lo' — the system crashed after transmitting just two letters of 'login'", "'Hi' — a deliberate greeting", "'SOS' — testing emergency communications", "'OK' — confirming the connection worked"], correct: 0, explanation: "They tried to send 'login' from UCLA to Stanford but the system crashed after 'L' and 'O.' So the first internet message was accidentally 'Lo.' Professor Kleinrock quipped: 'Lo is hello, and a more succinct, powerful, prophetic message we couldn't have wished for.'" },
    ruth: { options: ["'Lo' — the computer crashed mid-word!", "'Lo' — the computer crashed mid-word!", "The first internet message was an accident", "Eric's first email was probably more successful"], correct: 0, explanation: "They tried to type 'login' but it crashed after 'Lo'! The first internet message was an accident." } },
  { id: 792, category: "inventions", question: "Martin Cooper made the first mobile phone call on 3 April 1973. Who did he call, and why?", year: 1973,
    eric: { options: ["Joel Engel, head of AT&T's rival mobile phone project — to gloat", "His wife — to tell her he'd be late for dinner", "The White House — to inform the President", "His mother — because she always complained he never called"], correct: 0, explanation: "Joel Engel at AT&T — Motorola's rival! Cooper called him specifically to rub it in. The DynaTAC prototype was 9 inches tall, weighed 2.5 lbs, and had 35 minutes of battery. The first commercial mobile (1984) cost $3,995. Cooper is still alive at 97." },
    ruth: { options: ["His rival — to show off!", "His rival — to show off!", "The first mobile call was to gloat", "Eric got his first mobile somewhat later"], correct: 0, explanation: "He called his biggest rival to gloat! The first mobile phone call in history was a competitive flex." } },
  { id: 793, category: "inventions", question: "What does LASER stand for?", year: 1960,
    eric: { options: ["Light Amplification by Stimulated Emission of Radiation", "Linear Amplified Signal Emission Resonance", "Luminous Active Source of Electromagnetic Radiation", "Light-Activated Sequential Energy Release"], correct: 0, explanation: "Light Amplification by Stimulated Emission of Radiation. First built by Theodore Maiman at Hughes Research Laboratories on 16 May 1960, using a synthetic pink ruby crystal. When demonstrated, it was described as 'a solution looking for a problem.' The original ruby is in the Smithsonian." },
    ruth: { options: ["Light Amplification by Stimulated Emission of Radiation!", "Light Amplification by Stimulated Emission of Radiation!", "Eric can now spell it out", "Originally 'a solution looking for a problem'"], correct: 0, explanation: "Light Amplification by Stimulated Emission of Radiation! Nobody knew what to do with it at first." } },
  { id: 794, category: "inventions", question: "The first product scanned with a barcode was what, on 26 June 1974?", year: 1974,
    eric: { options: ["A 10-pack of Wrigley's Juicy Fruit chewing gum (67 cents, now in the Smithsonian)", "A can of Campbell's tomato soup", "A box of Kellogg's Corn Flakes", "A bottle of Coca-Cola"], correct: 0, explanation: "Wrigley's Juicy Fruit gum — scanned at 8:01 AM at Marsh Supermarket, Troy, Ohio. Chosen deliberately because nobody thought a barcode could be printed on something that small. Price: 67 cents. That pack of gum is now in the Smithsonian." },
    ruth: { options: ["Chewing gum!", "Chewing gum!", "Now in the Smithsonian", "Eric has scanned many barcodes since"], correct: 0, explanation: "A pack of chewing gum! The first barcode scan in history. It's now in a museum. As you'd expect." } },
  { id: 795, category: "inventions", question: "Velcro was inspired by what sticking to George de Mestral's dog in the Swiss Alps (1941)?", year: 1955,
    eric: { options: ["Burdock burrs — tiny hooks that caught on fur and fabric", "Pine needles — wedged into the dog's coat", "Thistle heads — tangled in the fur", "Spider webs — stretched between the dog's legs"], correct: 0, explanation: "Burdock burrs! De Mestral examined them under a microscope and saw hundreds of tiny hooks catching on loops in fabric and fur. 'Velcro' = French 'velours' (velvet) + 'crochet' (hook). It took 10 years to develop. He'd filed his first patent at age 12 — for a model aeroplane." },
    ruth: { options: ["Burdock burrs on his dog!", "Burdock burrs on his dog!", "Nature's own fastener", "Eric has Velcro on something (probably)"], correct: 0, explanation: "Burrs sticking to his dog! Nature invented hook-and-loop fasteners millions of years ago. De Mestral just noticed." } },
  { id: 796, category: "inventions", question: "Federico Faggin secretly did what to the Intel 4004 microprocessor (1971)?", year: 1971,
    eric: { options: ["Etched his initials 'F.F.' onto the chip — visible only under a microscope", "Programmed it to display 'Hello World' on startup", "Added a hidden game to the instruction set", "Named it after his daughter"], correct: 0, explanation: "He etched 'F.F.' onto the silicon! Visible only under a microscope. The 4004 had 2,300 transistors — roughly the same computing power as ENIAC, which had filled an entire room 25 years earlier. It was commissioned by Japanese calculator company Busicom." },
    ruth: { options: ["Etched his initials on the chip!", "Etched his initials on the chip!", "The world's tiniest graffiti", "Eric appreciates a craftsman's signature"], correct: 0, explanation: "He signed the world's first microprocessor with his initials! Only visible under a microscope. Pride of workmanship." } },
  { id: 797, category: "inventions", question: "Jonas Salk's polio vaccine (1955): when asked 'Who owns the patent?', what did he reply?", year: 1955,
    eric: { options: ["'The people. There is no patent. Could you patent the sun?'", "'I do, and I'm giving it away for free'", "'The government — they funded the research'", "'Nobody — I forgot to file the paperwork'"], correct: 0, explanation: "'The people, I would say. There is no patent. Could you patent the sun?' The vaccine would have been worth $7 billion. 80 million Americans donated to fund the research. Salk never won the Nobel Prize — some considered this a significant omission." },
    ruth: { options: ["'Could you patent the sun?'", "'Could you patent the sun?'", "He gave it away for free", "Eric admires selfless scientists"], correct: 0, explanation: "'Could you patent the sun?' He gave away a $7 billion invention. A hero." } },
  { id: 798, category: "inventions", question: "The ATM was invented in 1967. Why did the world get 4-digit PINs instead of 6?", year: 1967,
    eric: { options: ["Inventor John Shepherd-Barron's wife could only reliably remember 4 digits", "The keypad only had room for 4 buttons", "British banking regulations limited PINs to 4 digits", "6-digit PINs took too long to enter and caused queues"], correct: 0, explanation: "Shepherd-Barron proposed 6 digits but tested it on his wife Caroline, who could only reliably remember 4. The first ATM was at Barclays, Enfield, opened by TV actor Reg Varney. It used radioactive carbon-14 cheques. Maximum withdrawal: £10. His inspiration? Chocolate vending machines." },
    ruth: { options: ["His wife could only remember 4!", "His wife could only remember 4!", "She shaped global banking", "Eric remembers his PIN (hopefully)"], correct: 0, explanation: "His wife couldn't remember 6 digits! So 4-digit PINs became the world standard. One woman's memory shaped global banking." } },
  { id: 799, category: "inventions", question: "Teflon was used on which top-secret project before anyone thought to put it on a frying pan?", year: 1938,
    eric: { options: ["The Manhattan Project — sealing gaskets for uranium enrichment", "The Apollo programme — heat shields", "The Concorde project — friction reduction", "The SR-71 Blackbird — radar absorption"], correct: 0, explanation: "The Manhattan Project! Teflon (PTFE) sealed gaskets in uranium enrichment equipment. Roy Plunkett discovered it by accident at DuPont in 1938 — a white powder fell from a cylinder. Tefal pans didn't appear until 1954 (Marc Grégoire coated his fishing gear first, then his wife said: do my pans)." },
    ruth: { options: ["The atomic bomb project!", "The atomic bomb project!", "From nuclear weapons to frying eggs", "Eric's frying pan has Teflon"], correct: 0, explanation: "The Manhattan Project! Teflon helped build the atomic bomb before it helped fry eggs. His wife told him to coat her pans." } },
  { id: 800, category: "inventions", question: "Bubble Wrap (1957) was originally designed as what product?", year: 1957,
    eric: { options: ["Textured wallpaper — for the Beat generation", "Insulation for space suits", "A waterproof bandage", "Packaging material (its eventual use)"], correct: 0, explanation: "Textured wallpaper! Fielding and Chavannes sealed two plastic shower curtains together, trapping air bubbles, thinking it would appeal to hip 1950s interior designers. It flopped. Then they tried greenhouse insulation (also flopped). IBM's 1401 computer (1959) finally gave it a purpose — protecting fragile electronics during shipping." },
    ruth: { options: ["WALLPAPER!", "WALLPAPER!", "Nobody wanted bubble wallpaper", "Eric pops bubble wrap (everyone does)"], correct: 0, explanation: "They tried to sell it as wallpaper! Then greenhouse insulation! It took IBM to realise it was perfect for packaging." } },
  { id: 801, category: "inventions", question: "Super Glue was discovered accidentally — twice — by the same man. Who, and how far apart?", year: 1951,
    eric: { options: ["Harry Coover — 1942 (dismissed as a nuisance) and 1951 (when it bonded an expensive instrument)", "Roy Plunkett — 1938 and 1945", "Spencer Silver — 1968 and 1974", "Percy Spencer — 1943 and 1947"], correct: 0, explanation: "Harry Coover at Eastman Kodak. In 1942 he found cyanoacrylates stuck to everything (trying to make gunsights). He dismissed them. In 1951, a colleague bonded an expensive refractometer. THIS time Coover recognised what he had. During the Vietnam War, it was used to seal wounds in the field." },
    ruth: { options: ["Harry Coover — 9 years apart!", "Harry Coover — 9 years apart!", "Discovered the same thing twice", "Eric has glued his fingers together (probably)"], correct: 0, explanation: "Same man, same accident, nine years apart! The first time he threw it away. The second time he founded an industry." } },
  { id: 802, category: "inventions", question: "Dolly the Sheep (1996) was named after which celebrity, and why?", year: 1996,
    eric: { options: ["Dolly Parton — because she was cloned from a mammary gland cell, and 'we couldn't think of a more impressive pair of glands'", "Dolly the cartoon sheep from a children's TV show", "The inventor's daughter Dorothy (nicknamed Dolly)", "Dolly Madison, a former US First Lady"], correct: 0, explanation: "Dolly Parton! Ian Wilmut explained: 'Dolly is derived from a mammary gland cell and we couldn't think of a more impressive pair of glands than Dolly Parton's.' Parton said she was flattered. Dolly was the only success from 277 attempts. Her taxidermied body is at the National Museum of Scotland." },
    ruth: { options: ["Dolly Parton! Because of... mammary glands!", "Dolly Parton! Because of... mammary glands!", "Scientists have a sense of humour", "Eric may have seen Dolly (the sheep, in Edinburgh)"], correct: 0, explanation: "Dolly Parton! Because the cell came from a mammary gland. The scientists couldn't resist the joke." } },
  { id: 803, category: "inventions", question: "The Hubble Space Telescope's mirror had a flaw caused by a measurement error of how much?", year: 1990,
    eric: { options: ["1.3 millimetres in the positioning of one lens in the testing instrument — cost ~$700 million to fix", "1 metre — the mirror was the wrong diameter", "0.001mm — detectable only in space", "10cm — the mirror was clearly warped"], correct: 0, explanation: "1.3 millimetres! A lens in the null corrector (testing instrument) was 1.3mm from its correct position. This made the primary mirror too flat by 2.2 microns (1/50th of a hair). COSTAR corrective optics were installed in December 1993 by astronauts in five spacewalks. The fixed Hubble exceeded original specifications." },
    ruth: { options: ["1.3 millimetres! Cost $700 million to fix!", "1.3 millimetres! Cost $700 million to fix!", "A tiny error with a massive bill", "Eric appreciates precise measurements"], correct: 0, explanation: "One point three millimetres! That's all it took to blur a space telescope. Cost $700 million to fix." } },
  { id: 804, category: "inventions", question: "GPS was deliberately degraded for civilians until 2 May 2000. By how much?", year: 2000,
    eric: { options: ["Up to 100 metres (328 feet) — 'Selective Availability' made positions wander randomly", "Up to 1 km", "Up to 10 metres", "There was no degradation — this is a myth"], correct: 0, explanation: "Up to 100 metres! The military's 'Selective Availability' deliberately made civilian GPS wander. President Clinton ordered it off just after midnight on 2 May 2000. Accuracy improved from ±100m to ±10-20m overnight. GPS III satellites don't even have the capability to re-enable it." },
    ruth: { options: ["100 metres wrong — on purpose!", "100 metres wrong — on purpose!", "The military made it deliberately inaccurate", "Eric's sat-nav is much better now"], correct: 0, explanation: "100 metres wrong! The military deliberately made civilian GPS inaccurate until the year 2000. Then it got 10x better overnight." } },
  { id: 805, category: "inventions", question: "Stephanie Kwolek's technician initially refused to test her cloudy polymer solution. What happened when he did?", year: 1965,
    eric: { options: ["It produced Kevlar — five times stronger than steel by weight. The technician feared it would clog the machine", "It produced nylon — he was worried it would melt", "Nothing — the experiment failed but she tried again the next day", "It exploded — covering the lab in white fibre"], correct: 0, explanation: "Charles Smullen refused, worried it would clog the spinneret. Kwolek persuaded him. The resulting fibre (Kevlar) was five times stronger than steel by weight. Now used in bulletproof vests (estimated to have saved thousands of police officers' lives), racing sails, and aircraft. Kwolek was only the 4th woman in the National Inventors Hall of Fame." },
    ruth: { options: ["It made Kevlar — stronger than steel!", "It made Kevlar — stronger than steel!", "The technician said no, she said try it anyway", "Eric appreciates a persistent inventor"], correct: 0, explanation: "Kevlar! Five times stronger than steel. The technician said no. She insisted. Thousands of lives saved by bulletproof vests." } },
  { id: 806, category: "inventions", question: "John Goodenough was how old when he received the Nobel Prize for the lithium-ion battery in 2019?", year: 2019,
    eric: { options: ["97 — the oldest Nobel laureate in history at that time", "75", "85", "65"], correct: 0, explanation: "97 years old — the oldest Nobel laureate ever at that time. His key contribution (cobalt oxide cathode, doubling voltage to 4V) was made at Oxford in 1980. He shared the prize with Whittingham and Yoshino. Goodenough continued battery research into his late 90s and died in 2023 at 100." },
    ruth: { options: ["97! Oldest Nobel laureate ever!", "97! Oldest Nobel laureate ever!", "Still working at 97", "Eric is impressed (and inspired)"], correct: 0, explanation: "97 years old! The oldest Nobel laureate in history. Still doing research. Died at 100." } },
  { id: 807, category: "inventions", question: "The first pacemaker (1958) lasted how long before it needed replacing?", year: 1958,
    eric: { options: ["A few hours — it was replaced the next morning. The patient eventually received 26 pacemakers over 43 years", "10 years", "6 months", "It's still working today"], correct: 0, explanation: "A few hours! Implanted by Åke Senning in Stockholm on 8 October 1958. Patient Arne Larsson (aged 43) received 26 pacemakers over his remaining 43 years. He outlived both the inventor AND the surgeon, dying in 2001 aged 86. His wife had bullied the surgeon into performing the procedure by contacting him daily." },
    ruth: { options: ["A few HOURS!", "A few HOURS!", "He got 26 more after that", "His wife bullied the surgeon into doing it"], correct: 0, explanation: "A few hours! The patient got 26 more pacemakers and outlived everyone involved. His wife made it happen by nagging the surgeon daily." } },
  { id: 808, category: "inventions", question: "Rosalind Franklin's 'Photo 51' was crucial to discovering DNA's structure. What happened to her?", year: 1953,
    eric: { options: ["She died of ovarian cancer aged 37 in 1958 — four years before Watson, Crick, and Wilkins won the Nobel (which isn't awarded posthumously)", "She won the Nobel alongside Watson and Crick", "She moved to America and continued DNA research", "She was credited equally in the original 1953 paper"], correct: 0, explanation: "Franklin died of ovarian cancer in 1958, aged 37. Watson and Crick's Nature paper (25 April 1953, just 900 words long) relied on her X-ray diffraction image Photo 51, which Wilkins showed Watson without her knowledge. The 1962 Nobel went to Watson, Crick, and Wilkins. Watson himself said she would have won a Nobel in Chemistry had she lived." },
    ruth: { options: ["She died before the Nobel was awarded!", "She died before the Nobel was awarded!", "Her photo was used without her knowledge", "A great injustice of science"], correct: 0, explanation: "She died aged 37, four years before the Nobel. Her crucial photograph was shown to Watson without her consent." } },
  { id: 809, category: "inventions", question: "The first Pong arcade cabinet (1972) broke down within days of installation. Why?", year: 1972,
    eric: { options: ["The coin mechanism jammed because too many quarters had been stuffed in", "The screen burned out from overuse", "Players banged the controls too hard", "A power surge fried the circuit board"], correct: 0, explanation: "Too many quarters! The first cabinet was installed at Andy Capp's Tavern in Sunnyvale, California. It was so popular that the coin box overflowed and jammed the mechanism. Atari's Nolan Bushnell knew he had a hit. Tennis for Two (1958, on an oscilloscope) was technically the first video game, but Pong was the first commercial success." },
    ruth: { options: ["Too many coins jammed the machine!", "Too many coins jammed the machine!", "So popular it broke itself", "Eric has played Pong (surely)"], correct: 0, explanation: "So many coins were stuffed in that it broke! The first arcade game was too popular for its own good." } },
  { id: 810, category: "inventions", question: "ChatGPT launched on 30 November 2022. How fast did it reach 100 million users?", year: 2022,
    eric: { options: ["2 months — the fastest-growing consumer app in history (TikTok took 9 months, Instagram 2.5 years)", "1 year", "6 months", "1 week"], correct: 0, explanation: "Two months! 1 million users in 5 days, 100 million by January 2023. Eric has lived to see both ENIAC (1946, when he was 1) and computers that hold conversations. The AI that's writing these quiz questions exists because of the transistor (1947), the IC (1958), the microprocessor (1971), and the internet (1969)." },
    ruth: { options: ["2 months! Fastest ever!", "2 months! Fastest ever!", "Eric has seen it all — from ENIAC to AI", "This quiz was partly written by AI"], correct: 0, explanation: "Two months to 100 million users! Eric was born the same year as ENIAC. Now he's being quizzed by AI. What a lifetime." } },
  { id: 811, category: "inventions", question: "Post-it Notes were invented because Art Fry's bookmarks kept falling out of what?", year: 1980,
    eric: { options: ["His church hymn book", "His engineering textbook", "His novel on the train", "His recipe book in the kitchen"], correct: 0, explanation: "His church hymn book! Fry remembered Spencer Silver's 'useless' low-tack adhesive from a 3M seminar. He realised: 'What we have here isn't a bookmark — it's a whole new way to communicate.' The canary yellow colour was an accident too — the lab next door only had yellow scrap paper." },
    ruth: { options: ["His hymn book!", "His hymn book!", "From church to office essential", "Eric uses Post-its (who doesn't?)"], correct: 0, explanation: "His church hymn book! Bookmarks kept falling out. He remembered a 'useless' glue from work. The rest is history." } },
  { id: 812, category: "inventions", question: "The de Havilland Comet (1952) was the world's first commercial jet. What destroyed its lead?", year: 1954,
    eric: { options: ["Metal fatigue from pressurisation cycles — three aircraft disintegrated mid-flight, caused by a flaw of 2.2 microns", "Engine fires caused by fuel system design", "Wing failures in turbulence", "Landing gear collapse on tropical runways"], correct: 0, explanation: "Metal fatigue. Three Comets broke apart at altitude. The fuselage skin was too thin, and stress concentrations at window corners contributed. A 2.2 micron error — one-fiftieth of a human hair. The crashes destroyed Britain's lead in commercial aviation. Boeing's 707 (1958) learned from every one of de Havilland's mistakes." },
    ruth: { options: ["Metal fatigue — a flaw thinner than a hair!", "Metal fatigue — a flaw thinner than a hair!", "Britain lost its aviation lead forever", "Eric prefers modern jets"], correct: 0, explanation: "A flaw of 2.2 microns — one-fiftieth of a hair — destroyed three aircraft and Britain's aviation lead." } },
  { id: 813, category: "inventions", question: "The first nuclear power station connected to a grid was where? (Trick question!)", year: 1954,
    eric: { options: ["Obninsk, USSR (June 1954, 5 MWe) — though Calder Hall, UK (1956) was first large-scale commercial, and Shippingport, USA (1957) was first solely for electricity", "Calder Hall, Sellafield, UK (1956)", "Shippingport, Pennsylvania, USA (1957)", "Chalk River, Canada (1952)"], correct: 0, explanation: "Obninsk, USSR — June 1954, at a tiny 5 MWe. But Calder Hall (opened by the Queen, 17 October 1956) was the first large-scale commercial station — though its main purpose was making plutonium for bombs. Shippingport (1957) was the first built solely for electricity. The answer depends on how you define 'first'!" },
    ruth: { options: ["It depends on the definition!", "It depends on the definition!", "Three different 'firsts'", "Eric knows nuclear power history"], correct: 0, explanation: "Trick question! Obninsk was first to connect, Calder Hall first commercial-scale, Shippingport first purely for electricity." } },
  { id: 814, category: "inventions", question: "Sputnik transmitted what sound into space on 4 October 1957?", year: 1957,
    eric: { options: ["'Beep-beep-beep' — radio pulses for 22 days until the batteries died", "The Soviet national anthem", "Morse code spelling 'USSR'", "Nothing — it transmitted data silently"], correct: 0, explanation: "'Beep-beep-beep!' A polished metal sphere, 58 cm diameter, 83.6 kg, with four antennae. It transmitted for 22 days, orbited for 3 months, and caused worldwide panic about Soviet technological superiority. Amateur radio operators worldwide could pick up the signal. The Tornados' hit 'Telstar' reached #1 in both UK and US in 1962." },
    ruth: { options: ["Beep-beep-beep!", "Beep-beep-beep!", "The sound that terrified the West", "Eric was 13 when Sputnik launched"], correct: 0, explanation: "Beep-beep-beep! The most terrifying sound of the Cold War. A metal ball in space, beeping. The Space Age had begun." } },
  { id: 815, category: "inventions", question: "CRISPR gene editing won the 2020 Nobel Prize. What was historic about the recipients?", year: 2020,
    eric: { options: ["Jennifer Doudna and Emmanuelle Charpentier — the first Nobel Prize in science shared only by two women", "They were the youngest Nobel laureates ever", "They were from the same university department", "They had previously won Nobel Prizes in different fields"], correct: 0, explanation: "The first Nobel Prize in science shared exclusively by two women — Jennifer Doudna (American, UC Berkeley) and Emmanuelle Charpentier (French, then at Umeå University, Sweden). Their 2012 Science paper showed CRISPR-Cas9 could be programmed to cut specific DNA sequences. In 2023, the first CRISPR therapy (for sickle-cell disease) was approved." },
    ruth: { options: ["First Nobel in science shared only by two women!", "First Nobel in science shared only by two women!", "Making history in every way", "Eric celebrates scientific breakthroughs"], correct: 0, explanation: "The first Nobel Prize in science shared only by two women! They invented 'genetic scissors' that can edit DNA." } },
  { id: 816, category: "inventions", question: "The domestic smoke detector (1968-69) was invented because of what accident?", year: 1969,
    eric: { options: ["A smoking colleague walked into a room with an ion-based static control device — the smoke triggered the sensors", "A kitchen fire at the inventor's house", "A false alarm at a nuclear power station", "Lightning struck a factory's fire suppression system"], correct: 0, explanation: "Duane Pearsall's employee was testing an ion-based static control device when a smoking colleague walked in. The cigarette smoke disrupted the ion flow and changed the readings. Pearsall realised the same principle could detect fire. The SmokeGard 700 is estimated to have saved hundreds of thousands of lives." },
    ruth: { options: ["A smoker walked into the lab!", "A smoker walked into the lab!", "Cigarette smoke triggered the invention", "Eric has smoke detectors (essential)"], correct: 0, explanation: "A colleague lit a cigarette near a lab device and accidentally inspired the domestic smoke detector! Saved hundreds of thousands of lives." } },
  { id: 817, category: "inventions", question: "The Compact Disc was designed to hold 74 minutes of music. Why that specific length?", year: 1982,
    eric: { options: ["To fit a complete performance of Beethoven's Ninth Symphony", "That was the maximum the laser could read", "It matched the length of a standard vinyl LP", "74 minutes was the average concert length in 1980"], correct: 0, explanation: "Beethoven's Ninth! The original target was 60 minutes (115mm disc). Sony's VP Norio Ohga insisted on 74 minutes to accommodate the Ninth Symphony without interruption. The disc diameter was extended to 120mm. First CD pressed: ABBA's 'The Visitors' (17 August 1982). First album released: Billy Joel's '52nd Street' (1 October 1982)." },
    ruth: { options: ["To fit Beethoven's Ninth Symphony!", "To fit Beethoven's Ninth Symphony!", "Classical music shaped the CD", "Eric owns many CDs (probably)"], correct: 0, explanation: "Beethoven's Ninth! Sony's VP insisted the whole symphony must fit without turning the disc over." } },
  { id: 818, category: "inventions", question: "Josephine Cochrane invented the dishwasher (patented 1886). What motivated her?", year: 1886,
    eric: { options: ["Her servants kept chipping her fine china: 'If nobody else will invent one, I'll do it myself!'", "She hated washing up after dinner parties", "She was a professional caterer who needed faster turnaround", "Her husband bet her she couldn't build one"], correct: 0, explanation: "'If nobody else is going to invent a dishwashing machine, I'll do it myself!' Her servants kept chipping her fine china. She won recognition at the 1893 World's Columbian Exposition. Hotels adopted it immediately, but domestic models didn't take off until the 1950s. Her company eventually became KitchenAid." },
    ruth: { options: ["Her servants kept breaking her china!", "Her servants kept breaking her china!", "So she invented the dishwasher", "Eric uses one daily (hopefully)"], correct: 0, explanation: "Broken china! Rather than sack the servants, she invented a machine. Her company became KitchenAid." } },
  { id: 819, category: "inventions", question: "The first credit card transaction (8 February 1950) happened because Frank McNamara forgot what?", year: 1950,
    eric: { options: ["His wallet — while dining at Major's Cabin Grill, NYC. His wife had to rescue him", "His cheque book — at a hotel in Chicago", "His cash — at a petrol station", "His briefcase — at a business meeting"], correct: 0, explanation: "He forgot his wallet at a restaurant! His wife had to come and pay. Humiliated, he created the Diners Club card. He returned to the same restaurant on 8 February 1950 and paid with a cardboard card. First year: 10,000 members, 28 restaurants. The original cards were cardboard — first plastic card wasn't until 1961." },
    ruth: { options: ["His wallet! At a restaurant!", "His wallet! At a restaurant!", "His wife paid — he was mortified", "Eric always checks for his wallet"], correct: 0, explanation: "Forgot his wallet! His wife had to bail him out. So he invented a card you could pay with instead." } },
  { id: 820, category: "inventions", question: "Nick Holonyak Jr invented the visible red LED in 1962. Who won the 2014 Nobel for the blue LED, and why did blue matter?", year: 2014,
    eric: { options: ["Nakamura, Akasaki, and Amano — blue LEDs enabled white light (needed for LED lighting to replace bulbs)", "Watson and Crick — blue light revealed DNA structure", "Bohr and Heisenberg — blue photons proved quantum theory", "Edison and Tesla — posthumous recognition for electrical innovation"], correct: 0, explanation: "Shuji Nakamura, Isamu Akasaki, and Hiroshi Amano won the 2014 Nobel. Blue LEDs were the missing piece — you need blue light to create white LEDs (used for general lighting). Nakamura developed his breakthrough at Nichia, a small Japanese company. He sued for better compensation — initially awarded $190 million, settled for ~$8 million." },
    ruth: { options: ["Blue light makes white possible!", "Blue light makes white possible!", "No blue LED = no LED lighting", "Eric's house has LED bulbs"], correct: 0, explanation: "Blue was the missing colour! Without blue LEDs, you can't make white light. Every LED bulb in Eric's house depends on this." } },
  { id: 821, category: "inventions", question: "The first transatlantic fibre optic cable (TAT-8, 1988) could carry how many simultaneous calls?", year: 1988,
    eric: { options: ["40,000 — ten times more than the copper cables it supplemented", "1,000", "100", "500,000"], correct: 0, explanation: "40,000 simultaneous telephone calls — ten times more than existing copper cables. Charles Kao proposed in 1966 that ultra-pure glass could transmit light for kilometres. He won the 2009 Nobel in Physics but had been diagnosed with Alzheimer's in 2004 — his wife accepted the prize." },
    ruth: { options: ["40,000 calls at once!", "40,000 calls at once!", "Ten times more than copper", "Eric appreciates good telecommunications"], correct: 0, explanation: "40,000 simultaneous calls! Ten times more than copper. The invention that made the modern internet possible." } },
  { id: 822, category: "inventions", question: "Ian Wilmut, who created Dolly the Sheep, shares what with Eric?", year: 1996,
    eric: { options: ["They were both born in 1944", "They both studied at Aberdeen University", "They both worked for the NSHEB", "They both have dogs called Dolly"], correct: 0, explanation: "Both born in 1944! Wilmut (born 7 July 1944) created the world's first cloned mammal from an adult cell at the Roslin Institute near Edinburgh in 1996. He died in September 2023. Eric has lived through the same era — from wartime to cloning to AI." },
    ruth: { options: ["Both born in 1944!", "Both born in 1944!", "Same year as the cloning pioneer", "Eric has had quite a lifetime too"], correct: 0, explanation: "Born the same year! Eric and Ian Wilmut — 1944 classmates in the march of time. One cloned a sheep. The other gets a quiz." } },
  { id: 823, category: "inventions", question: "The airbag inflates in approximately how long?", year: null,
    eric: { options: ["30 milliseconds — faster than the blink of an eye (300-400 ms)", "1 second", "Half a second", "100 milliseconds"], correct: 0, explanation: "30 milliseconds — about 10 times faster than blinking. Allen Breed invented the ball-in-tube crash sensor in 1967. Sodium azide explodes to inflate the bag. First production vehicle with an airbag: the 1973 Oldsmobile Toronado. John Hetrick filed the first airbag patent in 1952." },
    ruth: { options: ["30 milliseconds! Faster than a blink!", "30 milliseconds! Faster than a blink!", "A small explosion saves your life", "Eric's car has airbags (important)"], correct: 0, explanation: "30 milliseconds! Ten times faster than blinking. A tiny explosion inflates a bag that saves your life." } },
  { id: 824, category: "inventions", question: "The MRI scanner Nobel Prize (2003) controversially excluded whom?", year: 2003,
    eric: { options: ["Raymond Damadian — who proposed the concept and built the first scanner, but was omitted in favour of Lauterbur and Mansfield", "The patient who volunteered for the first scan", "The nurse who operated the machine", "The hospital administrator who funded the research"], correct: 0, explanation: "Raymond Damadian — who proposed using NMR to detect cancer (1971) and built the first MRI scanner 'Indomitable' (1977). He took out full-page ads in the NYT headlined 'The Shameful Wrong That Must Be Righted.' The Nobel can include 3 people but the committee chose only Lauterbur and Mansfield." },
    ruth: { options: ["Raymond Damadian — who built the first scanner!", "Raymond Damadian — who built the first scanner!", "He took out newspaper ads to protest", "Eric thinks he should have been included"], correct: 0, explanation: "The man who built the first MRI scanner was left out of the Nobel Prize! He took out full-page newspaper ads in protest." } },
  { id: 825, category: "inventions", question: "The contraceptive pill (FDA approved 1960) was funded by Katharine McCormick. Who championed the idea?", year: 1960,
    eric: { options: ["Margaret Sanger — the activist who recruited the scientific team in 1950 (she was 71 when the pill reached market)", "Eleanor Roosevelt", "Marie Stopes", "Florence Nightingale"], correct: 0, explanation: "Margaret Sanger proposed the idea and recruited biologist Gregory Pincus in 1950. McCormick funded the research. Carl Djerassi developed the key synthetic progestin in Mexico City in 1951. Catholic doctor John Rock ran the clinical trials. Within 2 years, 1.2 million women were using the pill. Sanger was 71 when it finally reached the market." },
    ruth: { options: ["Margaret Sanger — she was 71 when it launched!", "Margaret Sanger — she was 71 when it launched!", "A lifetime campaigning for the pill", "One of the most important inventions ever"], correct: 0, explanation: "Margaret Sanger campaigned from 1950 and was 71 when the pill finally reached women. A lifetime's work." } },
  { id: 826, category: "inventions", question: "Tim Berners-Lee invented the World Wide Web. Did he patent it?", year: 1991,
    eric: { options: ["No — CERN made the Web protocol royalty-free on 30 April 1993, enabling its explosive global growth", "Yes — he licensed it to every internet provider", "No — because the US government classified it as a military invention", "Yes — but the patent was invalidated in 2005"], correct: 0, explanation: "No! On 30 April 1993, CERN made the Web protocol and code available royalty-free. Berners-Lee (British, working at CERN in Geneva) proposed the system on 12 March 1989. The first website (http://info.cern.ch) went live in December 1990. If he'd patented it, the internet as we know it might never have happened." },
    ruth: { options: ["No — he gave it away for free!", "No — he gave it away for free!", "Like Salk and the polio vaccine", "Eric uses the web every day because of this"], correct: 0, explanation: "He gave it away! Like Salk and the polio vaccine. If he'd charged for it, the internet might never have taken off." } },

  // ─── Screwdrivers ─────────────────────────────────────────────
  { id: 827, category: "screwdrivers", question: "Henry Phillips didn't actually invent the Phillips screw. Who did?", year: 1935,
    eric: { options: ["John P. Thompson (patented 1932) — Phillips bought the design in 1935 and commercialised it", "Thomas Edison", "Isambard Kingdom Brunel", "Henry Ford's chief engineer"], correct: 0, explanation: "John P. Thompson patented the cruciform recessed screw in 1932 (US Patent 1,908,080). After failing to interest manufacturers, he sold the design to Henry Phillips in 1935. Phillips founded the Phillips Screw Company and got GM to use it on 1936 Cadillacs. By 1940, 85% of US screw makers had licensed it." },
    ruth: { options: ["John P. Thompson!", "John P. Thompson!", "Phillips just bought and marketed it", "Eric knows his screw history"], correct: 0, explanation: "Thompson invented it, Phillips sold it! The man who actually designed the screw never got the credit." } },
  { id: 828, category: "screwdrivers", question: "The Robertson (square drive) screw is hugely popular in Canada but virtually unknown elsewhere. Why?", year: 1908,
    eric: { options: ["Peter Robertson refused to license the design exclusively to Henry Ford — so Ford adopted Phillips instead", "It was banned under US patent law", "The square shape was too expensive to manufacture", "Canadian export restrictions prevented overseas sales"], correct: 0, explanation: "Peter L. Robertson of Milton, Ontario invented it in 1906-08. When Henry Ford tried it and loved it (saved time on Model T production), he wanted to secure licensing. Robertson refused. Ford couldn't guarantee supply and chose Phillips instead. Robertson's stubbornness kept the best screw drive in the world confined to one country." },
    ruth: { options: ["The inventor refused to license it to Ford!", "The inventor refused to license it to Ford!", "Canada's best-kept secret", "Eric would love a Robertson"], correct: 0, explanation: "The inventor said no to Henry Ford! So the best screw drive in the world stayed in Canada." } },
  { id: 829, category: "screwdrivers", question: "How does Pozidriv differ from Phillips?", year: 1962,
    eric: { options: ["Pozidriv has extra indentations at 45° to the main cross, parallel flanks, and a blunt tip — designed not to cam out", "Pozidriv is just a metric version of Phillips", "Pozidriv has only two slots instead of four", "There's no real difference — they're interchangeable"], correct: 0, explanation: "Pozidriv (patented by GKN in 1962) has additional radial indentations at 45° to the main cross recess, parallel flanks (not tapered), and a blunt tip. It's designed NOT to cam out. Phillips drivers WILL fit Pozidriv screws loosely but will strip the head under torque. They look interchangeable but absolutely are not." },
    ruth: { options: ["Extra marks at 45° — doesn't slip!", "Extra marks at 45° — doesn't slip!", "They look the same but they're NOT", "Eric has ruined screws using the wrong one"], correct: 0, explanation: "Extra indentations at 45 degrees! Using a Phillips driver on a Pozidriv screw will strip it. They are NOT interchangeable." } },
  { id: 830, category: "screwdrivers", question: "The first documented screwdriver appears in which medieval manuscript?", year: null,
    eric: { options: ["The Housebook of Wolfegg Castle (1475-1490, Germany) — with pear-shaped handles for slotted screws", "Leonardo da Vinci's Codex Atlanticus (1478)", "The Nuremberg Workshop Manual (1510)", "Geoffrey Chaucer's Canterbury Tales (1392)"], correct: 0, explanation: "The Housebook of Wolfegg Castle, a manuscript written between 1475 and 1490. These earliest screwdrivers had pear-shaped handles and were made for slotted screws. Probably invented in late 15th century Germany or France. Gunsmiths still call a screwdriver a 'turnscrew' — the older term." },
    ruth: { options: ["A 15th-century German manuscript!", "A 15th-century German manuscript!", "Screwdrivers are 550 years old", "Eric's is slightly more modern"], correct: 0, explanation: "A medieval German manuscript from the 1470s! The first screwdrivers had pear-shaped handles. 550 years of turning screws." } },
  { id: 831, category: "screwdrivers", question: "Torx (star drive) was developed in 1967. What does 'Security Torx' have that standard Torx doesn't?", year: 1967,
    eric: { options: ["A pin in the centre of the head that prevents a standard Torx driver from being inserted", "An extra lobe (7 points instead of 6)", "A magnetic lock that requires a special key", "A rubber seal to prevent water ingress"], correct: 0, explanation: "A post (pin) in the centre of the recess. Standard Torx drivers can't fit over the pin. You need a special hollow-centred bit. Used as tamper-resistant fasteners on public benches, electronics, and infrastructure. Also: AudiTorx heads deliberately snap off when the correct torque is reached — used on railways." },
    ruth: { options: ["A pin in the middle!", "A pin in the middle!", "Stops normal drivers from fitting", "Eric has the special bits (of course)"], correct: 0, explanation: "A pin right in the centre! You need a special hollow driver. Designed to stop people who shouldn't be unscrewing things." } },
  { id: 832, category: "screwdrivers", question: "Allen keys are named after a company, not a person. But William G. Allen patented what in 1909-1910?", year: 1910,
    eric: { options: ["A method of cold-forming screw heads around a hexagonal die — creating the hex socket screw", "The Allen wrench itself", "A type of bicycle spanner", "A hexagonal nut and bolt combination"], correct: 0, explanation: "The cold-forming manufacturing method (US Patent 960,244). The 'Allen safety set screw' was first advertised in 1910. The original safety motivation: factory workers' clothing would catch on protruding set screws and pull them into rotating shafts. Recessed hex screws eliminated the hazard." },
    ruth: { options: ["A way to manufacture hex socket screws!", "A way to manufacture hex socket screws!", "Named after the Allen Manufacturing Company", "Eric has a set of Allen keys somewhere"], correct: 0, explanation: "The manufacturing method! Allen keys exist because factory workers were getting dragged into machinery by protruding screws." } },
  { id: 833, category: "screwdrivers", question: "JIS (Japanese Industrial Standard) screws look like Phillips but aren't. What happens if you use a Phillips driver?", year: null,
    eric: { options: ["It damages the screw head — Phillips has rounded tapered flutes that don't seat properly in JIS's straighter geometry", "Nothing — they're fully compatible", "The screwdriver breaks", "The screw welds itself to the surface"], correct: 0, explanation: "Phillips drivers have rounded, tapered flutes designed to cam out. JIS screws (JIS B 1012) have straighter, sharper internal geometry. A Phillips driver doesn't seat properly and strips the head. JIS screws have a dot or 'X' marking to identify them. Often incorrectly called 'Japanese Phillips.'" },
    ruth: { options: ["It strips the screw head!", "It strips the screw head!", "They look the same but they're NOT", "Eric knows the difference (now)"], correct: 0, explanation: "Strips the head! Phillips and JIS look identical but the internal shapes are different. One of engineering's cruellest traps." } },
  { id: 834, category: "screwdrivers", question: "The Yankee screwdriver (spiral ratchet) works by pushing. When was it first marketed?", year: 1895,
    eric: { options: ["1895, by North Brothers Manufacturing Company", "1950, by Stanley Tools", "1920, by Snap-on", "1875, by Sears Roebuck"], correct: 0, explanation: "1895 by North Brothers Manufacturing. Push the handle and a spiral groove rotates the bit. Stanley acquired the brand in the 1940s. Production ended in the US in 2005, UK in 2007, when the tooling was sent to Japan and later scrapped. A beautiful tool, killed by the cordless drill." },
    ruth: { options: ["1895!", "1895!", "Push to turn — very clever", "Killed by the cordless drill"], correct: 0, explanation: "1895! Push the handle and it spins. Beautiful engineering. Sadly extinct — last ones made in 2007." } },
  { id: 835, category: "screwdrivers", question: "VDE-rated insulated screwdrivers are tested to withstand what voltage?", year: null,
    eric: { options: ["1,000V AC (tested at 10,000V) — with distinctive red/orange and yellow handles", "240V AC (tested at 500V)", "415V AC (tested at 1,000V)", "50V DC only"], correct: 0, explanation: "1,000V AC, tested at 10,000V per IEC 60900. The red/orange and yellow handles are distinctive identification. VDE = Verband der Elektrotechnik (German standards body). Essential for anyone working on live electrical equipment — like 132kV substations, for instance." },
    ruth: { options: ["1,000 volts! Tested at 10,000!", "1,000 volts! Tested at 10,000!", "The orange and yellow handles mean safety", "Eric uses VDE tools (he'd better)"], correct: 0, explanation: "Tested at ten thousand volts! The bright handles mean 'this one won't kill you.' Essential for electrical engineers." } },
  { id: 836, category: "screwdrivers", question: "Apple uses a proprietary 5-pointed screw called what, specifically to stop customers opening their devices?", year: 2009,
    eric: { options: ["Pentalobe — first used on the MacBook Pro in 2009, now on iPhones, Apple Watch, and MacBook Air", "Torx T2 — borrowed from the aerospace industry", "Quintastar — designed by Jony Ive", "Apple Hex — a proprietary 5-sided hex"], correct: 0, explanation: "Pentalobe — a 5-pointed tamper-resistant system. First used mid-2009 on MacBook Pro batteries. Sizes range from 0.8mm (iPhone) to 1.5mm (MacBook Pro). Apple doesn't want you opening your devices. The 'right to repair' movement considers this a deliberate anti-consumer tactic." },
    ruth: { options: ["Pentalobe! A 5-pointed Apple screw!", "Pentalobe! A 5-pointed Apple screw!", "Apple doesn't want you inside", "Eric has opinions about this"], correct: 0, explanation: "Pentalobe! Apple invented their own screw to stop you repairing your own phone. Eric would not approve." } },

  // ─── Tea & Teabag Reuse ───────────────────────────────────────
  { id: 837, category: "tea", question: "A typical black teabag releases what percentage of its caffeine on the FIRST steep?", year: null,
    eric: { options: ["70-80% — leaving only 10-20% of antioxidants for the second steep", "About 30% — plenty left for reuse", "About 50% — half and half", "About 95% — virtually nothing left"], correct: 0, explanation: "70-80% of caffeine and flavour on the first steep. The second steep yields only 10-20% of the original antioxidant levels. A 5-minute steep extracts 69% of caffeine; 10 minutes gets 92%; 15 minutes gets virtually all of it. Eric's reused teabags are essentially hot brown water." },
    ruth: { options: ["70-80% — the second cup is mostly water!", "70-80% — the second cup is mostly water!", "Eric's second cup is basically brown", "The science says stop reusing, Eric"], correct: 0, explanation: "70-80% gone on the first brew! Eric's second cup is scientifically proven to be almost entirely just hot water with a memory of tea." } },
  { id: 838, category: "tea", question: "How long can a used teabag sit at room temperature before mould starts growing?", year: null,
    eric: { options: ["Over 4 hours — Aspergillus and Penicillium moulds colonise damp teabags left out", "About 30 minutes", "About 24 hours", "Indefinitely — tea is antimicrobial"], correct: 0, explanation: "Over 4 hours at room temperature and colonies of Aspergillus and Penicillium moulds can develop. If you must reuse (Eric), refrigerate in a sealed container and use within 6-8 hours maximum. Never more than 24 hours. If it smells funky, bin it. The boiling water of the next brew does NOT reliably kill all bacteria." },
    ruth: { options: ["4 hours — then the mould arrives!", "4 hours — then the mould arrives!", "Refrigerate immediately if reusing", "Eric, please listen to this one"], correct: 0, explanation: "Four hours! Then the mould moves in. Refrigerate your used teabag immediately, Eric. This is a health warning." } },
  { id: 839, category: "tea", question: "If Eric reuses every teabag once (4 cups/day, halving consumption), how much does he save per year?", year: null,
    eric: { options: ["Approximately £36.50 per year (730 fewer teabags at ~5p each)", "Approximately £365 per year", "Approximately £3.65 per year", "Approximately £150 per year"], correct: 0, explanation: "About £36.50 per year. Over 50 years of tea drinking, that's roughly £1,825 — about the price of a very modest second-hand car. The average UK lifetime tea cost is £6,622 (62,046 cups over 81 years at ~11p each). Eric's reuse strategy saves money but costs dignity." },
    ruth: { options: ["£36.50 a year!", "£36.50 a year!", "£1,825 over a lifetime", "Is it really worth it, Eric?"], correct: 0, explanation: "Thirty-six pounds fifty! Over a lifetime: enough for a terrible second-hand car. Worth the mouldy teabags? Debatable." } },
  { id: 840, category: "tea", question: "In Chinese gongfu tea culture, which steep is often considered the BEST?", year: null,
    eric: { options: ["The second — the first is considered a 'rinse' to awaken the leaves", "The first — freshest and strongest", "The fifth — when the leaves are fully open", "The last — when the subtle flavours emerge"], correct: 0, explanation: "The second steep! In gongfu ('making tea with skill'), the first steep is a rinse to awaken the leaves. The second is 'the most flavorful, for by then the infusion has reached full strength.' Up to 8-12 steeps from the same leaves. In China, re-steeping is an ART FORM. In Britain, it's called being tight-fisted." },
    ruth: { options: ["The SECOND steep! The first is just a rinse!", "The SECOND steep! The first is just a rinse!", "In China, Eric would be a connoisseur", "Same practice, opposite cultural readings"], correct: 0, explanation: "The second! In China, Eric's teabag reuse would make him a sophisticated tea master. In Scotland, it makes him tight." } },
  { id: 841, category: "tea", question: "The teabag was invented by accident in 1908. How?", year: 1908,
    eric: { options: ["Thomas Sullivan sent tea samples in silk bags — customers dunked the whole bag instead of emptying it", "A factory worker dropped a cotton sack into a brewing vat", "A chemist accidentally sealed tea in filter paper during experiments", "A sailor wrapped tea in cloth to keep it dry at sea"], correct: 0, explanation: "Thomas Sullivan, a New York tea merchant, sent samples in small silk bags. Customers were supposed to empty them into a teapot — instead they dunked the whole bag in. The teabag was born by accident. Tetley introduced teabags to Britain in 1953. By 2007, teabags accounted for 96% of the British market." },
    ruth: { options: ["Customers dunked the sample bags by mistake!", "Customers dunked the sample bags by mistake!", "The best inventions are accidents", "Eric should thank Thomas Sullivan"], correct: 0, explanation: "An accident! Customers were supposed to open the bags but just dunked them whole. And the world was changed forever." } },
  { id: 842, category: "tea", question: "Which country drinks the most tea per capita — and where does the UK rank?", year: null,
    eric: { options: ["Turkey is #1 (3.16 kg/year), Ireland #2, UK only #3", "UK is #1 (obviously)", "China is #1, Japan #2, UK #3", "India is #1, UK #2, Turkey #3"], correct: 0, explanation: "Turkey drinks the most tea per capita — 3.16 kg per year (~1,300 cups), roughly 63% more than the UK. Ireland is second (2.19 kg). The UK is only third (1.94 kg). Despite its reputation, Britain is NOT the world's biggest tea drinker. The UK drinks 100 million cups per day and uses 61 billion teabags per year." },
    ruth: { options: ["Turkey! The UK is only THIRD!", "Turkey! The UK is only THIRD!", "Turkey drinks 63% more than the UK", "Eric is doing his best to close the gap"], correct: 0, explanation: "Turkey! Not Britain! Turkey drinks 63% more tea per person than the UK. Ireland beats us too." } },
  { id: 843, category: "tea", question: "George Orwell's Rule 11 for making tea (1946) says what about sugar?", year: 1946,
    eric: { options: ["'How can you call yourself a true tea-lover if you destroy the flavour by putting sugar in it? It would be equally reasonable to put in pepper or salt'", "'Two sugars, no more, no less'", "'Brown sugar only — white sugar is for coffee'", "'Sugar is acceptable if you are under 12 years old'"], correct: 0, explanation: "Orwell was SAVAGE about sugar in tea. His essay 'A Nice Cup of Tea' (Evening Standard, 12 January 1946) listed 11 rules. Rule 11: no sugar. Rule 6: take the teapot to the kettle (water must be actually boiling). Rule 10: tea first, then milk. He used 6 heaped teaspoons for a quart pot." },
    ruth: { options: ["'It would be equally reasonable to put in pepper or salt'!", "'It would be equally reasonable to put in pepper or salt'!", "Orwell took tea VERY seriously", "Eric agrees with Orwell (probably)"], correct: 0, explanation: "Orwell compared sugar in tea to pepper or salt! His 11 rules are the most opinionated brewing guide ever written." } },
  { id: 844, category: "tea", question: "ISO 3103 is the international standard for brewing tea. What did it win in 1999?", year: 1999,
    eric: { options: ["The Ig Nobel Prize for Literature", "The Nobel Prize for Chemistry", "The Queen's Award for Enterprise", "The Golden Teapot Award"], correct: 0, explanation: "The Ig Nobel Prize for Literature — the parody Nobel for improbable research. ISO 3103 (based on British Standard BS 6008:1980) specifies brewing method, water temperature, pot material, and even says milk should go in FIRST — contradicting George Orwell's Rule 10." },
    ruth: { options: ["The Ig Nobel Prize!", "The Ig Nobel Prize!", "A standard for making tea won a joke prize", "Eric follows his own standard"], correct: 0, explanation: "The Ig Nobel! An international standard for making tea. It even specifies milk first — which Orwell would have hated." } },
  { id: 845, category: "tea", question: "PG Tips' pyramid teabag was developed with scientists from which university?", year: 1996,
    eric: { options: ["Imperial College London — tested cylinders, cubes, and even top hats before settling on the pyramid", "Oxford University", "Cambridge University", "Edinburgh University"], correct: 0, explanation: "Imperial College London! Four years of development, testing every shape including top hats. The pyramid gave leaves 50% more room to circulate than flat bags. Launched 1996, made up a fifth of UK teabag sales by 1999. Production ceased in 2023 when the special machines were decommissioned." },
    ruth: { options: ["Imperial College London!", "Imperial College London!", "They tried top hats before pyramids", "Eric doesn't care about the shape (just reuses it)"], correct: 0, explanation: "Imperial College! They tested cylinders, cubes, and top hats. The pyramid won. Then they stopped making them in 2023." } },
  { id: 846, category: "tea", question: "Many teabags contain what hidden material that makes them non-compostable?", year: null,
    eric: { options: ["Polypropylene (plastic) — used to heat-seal the fibres, making up 20-30% of the bag", "Lead — in the ink used to print the label", "Mercury — in the adhesive", "Asbestos — as a heat-resistant lining"], correct: 0, explanation: "Polypropylene — a plastic used to heat-seal the paper fibres. 20-30% of a standard teabag is plastic. A single plastic teabag can release approximately 11.6 BILLION microplastics into a single cup. 167 million teabags are disposed of daily in the UK alone." },
    ruth: { options: ["Plastic! 20-30% of the bag!", "Plastic! 20-30% of the bag!", "11.6 billion microplastics per cup", "Eric reuses AND drinks microplastics"], correct: 0, explanation: "Plastic! Nearly a third of the teabag. And each brew releases billions of microplastics. Tea is complicated." } },
  { id: 847, category: "tea", question: "At its peak in the 18th century, what fraction of tea consumed in Britain was smuggled?", year: null,
    eric: { options: ["Over three-quarters — the government tax was 119%, making smuggling enormously profitable", "About half", "About a quarter", "Less than 10% — the Royal Navy caught most smugglers"], correct: 0, explanation: "Over 75%! Tax peaked at 119% of the tea's value. In 1784, PM William Pitt the Younger (aged just 24) slashed tea duty from 119% to 12.5% via the Commutation Act. Smuggling 'vanished virtually overnight.' Legal imports nearly tripled in one year." },
    ruth: { options: ["Over three-quarters! Tax was 119%!", "Over three-quarters! Tax was 119%!", "Smuggled tea was a national industry", "Eric would have been a smuggler"], correct: 0, explanation: "75% of all tea was smuggled! Because the tax was 119%. A 24-year-old PM fixed it by slashing the tax. Problem solved." } },
  { id: 848, category: "tea", question: "'High tea' sounds posh but actually means what?", year: null,
    eric: { options: ["A working-class hearty evening meal served at a HIGH dining table — 'afternoon tea' is the posh one", "An elegant afternoon of sandwiches and scones served on a high table", "Tea served at high altitude (in Scottish castles)", "Tea brewed extra-strong by leaving the bag in longer"], correct: 0, explanation: "'High tea' is a working-class hearty evening meal (meat, bread, cheese, cake) served at a HIGH (dining) table. 'Afternoon tea' (small sandwiches, scones, clotted cream) is the refined, upper-class tradition served at LOW tables (coffee tables/side tables). Everyone gets this backwards." },
    ruth: { options: ["A working-class dinner — NOT posh!", "A working-class dinner — NOT posh!", "Afternoon tea is the posh one", "Eric knows the difference"], correct: 0, explanation: "High tea = dinner! Afternoon tea = posh sandwiches. 'High' refers to the tall dining table, not the social class." } },
  { id: 849, category: "tea", question: "Catherine of Braganza arrived in England in 1662 and asked for tea. What happened?", year: 1662,
    eric: { options: ["Nobody had any — tea was virtually unknown in England. She made it fashionable at court", "She was served the finest Chinese tea immediately", "She was offered ale and told tea was for the sick", "The kitchen staff brewed coffee by mistake"], correct: 0, explanation: "Nobody had any! Catherine, a Portuguese princess, married Charles II and arrived at Portsmouth on 13 May 1662. She asked for tea — none was available. She made it fashionable at court, transforming it from a medicinal drink into a social ritual. The East India Company presented Charles with 2 lbs 2 oz of tea — a princely gift." },
    ruth: { options: ["Nobody had any tea!", "Nobody had any tea!", "She made it fashionable", "The woman who gave Britain its national drink"], correct: 0, explanation: "She asked for tea and nobody had any! So she made it fashionable at court. Britain owes its tea addiction to a Portuguese princess." } },
  { id: 850, category: "tea", question: "Tetley introduced teabags to Britain in 1953. By 2007, what percentage of the British market did teabags account for?", year: 2007,
    eric: { options: ["96% — loose leaf tea virtually disappeared", "75%", "50%", "85%"], correct: 0, explanation: "96%! In the early 1960s, teabags were under 3% of the market. By the 1980s, over 50%. By 2007, 96%. Tetley also invented the round teabag in 1989 (designed to fit mugs, not teapots). Britain went from a teapot nation to a mug-and-bag nation in 50 years." },
    ruth: { options: ["96%!", "96%!", "From 3% to 96% in 50 years", "Eric uses teabags (twice each)"], correct: 0, explanation: "96%! Loose leaf tea virtually disappeared. A complete revolution in 50 years. And Eric reuses every single one." } },
  { id: 851, category: "tea", question: "The world's most expensive tea, Da Hong Pao, sold 20 grams for how much in 2002?", year: 2002,
    eric: { options: ["$28,000 (~$1.4 million per kilogram) — only 6 original mother trees remain, state-protected", "£500", "$2,800", "$280"], correct: 0, explanation: "$28,000 for 20 grams — roughly $1.4 million per kilogram. 'Da Hong Pao' means 'Big Red Robe.' Only six original mother trees remain in the Wuyi Mountains of China, and they are state-protected and no longer harvested. Eric would get approximately 4 cups from that 20 grams — or 8 cups if he reuses the leaves." },
    ruth: { options: ["$28,000 for 20 grams!", "$28,000 for 20 grams!", "Eric would DEFINITELY reuse those leaves", "At that price, he'd reuse them 100 times"], correct: 0, explanation: "$28,000! At that price, even non-reusers would reuse. Eric would steep those leaves until they dissolved." } }
